...
ActorInfo gChTanktupLegFrontLeft = {
    MARKER_6D_TANKTUP_LEG, ACTOR_E9_TANKTUP_LEG_FL, ASSET_3EF_MODEL_TANKTUP_LEG_FL,
    0x01, chTanktupLegFrontLeftAnimations,
...
ActorInfo gChTanktupLegBackLeft = {
    MARKER_6D_TANKTUP_LEG, ACTOR_EA_TANKTUP_LEG_BL, ASSET_3F0_MODEL_TANKTUP_LEG_BL,
    0x01, chTanktupLegBackLeftAnimations,
    chTanktupLeg_update, actor_update_func_80326224, actor_draw,
    0, 0x166, 0.0f, 0
};
u8 pad_80390CEC[4] = {0};
...
ActorInfo gChTanktupLegFrontRight = {
    MARKER_6D_TANKTUP_LEG, ACTOR_EB_TANKTUP_LEG_FR, ASSET_3F1_MODEL_TANKTUP_LEG_FR,
    0x01, chTanktupLegFrontRightAnimations,
    chTanktupLeg_update, actor_update_func_80326224, actor_draw,
    0, 0x166, 0.0f, 0
};
u8 pad_80390C2C[4] = {0};
...
ActorInfo gChTanktupLegBackRight = {
    MARKER_6D_TANKTUP_LEG, ACTOR_EC_TANKTUP_LEG_BR, ASSET_3F2_MODEL_TANKTUP_LEG_BR,
    0x01, chTanktupLegBackRightAnimations,
    chTanktupLeg_update, actor_update_func_80326224, actor_draw,
    0, 0x166, 0.0f, 0
};
