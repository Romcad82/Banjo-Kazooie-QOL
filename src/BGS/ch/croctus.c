...
void chCroctus_update(Actor *this);
...
ActorInfo gChCroctus ={
    MARKER_FC_CROCTUS, ACTOR_1FA_CROCTUS, ASSET_425_MODEL_CROCTUS,
    1, chCroctusAnimations,
    chCroctus_update, actor_update_func_80326224, chCroctus_draw,
    0, 0, 0.0f, 0
};

enum chCroctusState {
    CHCROCTUS_STATE_1_MOUTH_CLOSED = 1,
    CHCROCTUS_STATE_2_MOUTH_OPENING,
    CHCROCTUS_STATE_3_MOUTH_OPEN,
    CHCROCTUS_STATE_4_MOUTH_CLOSING,
    CHCROCTUS_STATE_5_FED,
    CHCROCTUS_STATE_6_DESPAWN,
};
...
void func_80387D18(ActorMarker * arg0, u32 arg1){
    ...
    nextActPtr->state = CHCROCTUS_STATE_2_MOUTH_OPENING;
...
void chCroctus_update(Actor *this){
    ...
    if(this->unk38_31){
        if ((this->state != CHCROCTUS_STATE_5_FED) && (this->state != CHCROCTUS_STATE_6_DESPAWN)) {
    ...
    switch(this->state){
        case CHCROCTUS_STATE_1_MOUTH_CLOSED:// L80388370
            this->lifetime_value += time_getDelta();
            if(0.7 <= this->lifetime_value){
                subaddie_set_state_with_direction(this, CHCROCTUS_STATE_2_MOUTH_OPENING, 0.0f, 1);
                func_80387C90(this);
                this->lifetime_value = 0.0f;
        ...
        case CHCROCTUS_STATE_2_MOUTH_OPENING:// L80388400
            if(actor_animationIsAt(this, 0.62f)){
                subaddie_set_state_with_direction(this, CHCROCTUS_STATE_3_MOUTH_OPEN, 0.62f, 1);
            }
            break;

        case CHCROCTUS_STATE_3_MOUTH_OPEN:// L80388434
            this->lifetime_value += time_getDelta();
            if( this->lifetime_value >= 0.13 + 0.7/4 * (5 - this->actorTypeSpecificField)){
                subaddie_set_state_with_direction(this, CHCROCTUS_STATE_4_MOUTH_CLOSING, 0.62f, 1);
                func_80387C90(this);
                this->lifetime_value = 0.0f;
                func_80324D54(0.3f, SFX_406_GOLD_BULLION_TALKING, 1.0f, 0x55f0, this->position, 0.0f, 1800.0f);
            }
            break;

        case CHCROCTUS_STATE_4_MOUTH_CLOSING:// L8038850C
            if(actor_animationIsAt(this, 0.0f)){
                subaddie_set_state_with_direction(this, CHCROCTUS_STATE_1_MOUTH_CLOSED, 0.0f, 1);
            }
            break;

        case CHCROCTUS_STATE_5_FED:// L80388538
        ...
        case CHCROCTUS_STATE_6_DESPAWN:// L803885B0
            func_80328748(this->anctrl, 0.79f, 0.97f);
