...
ActorInfo D_80394C4C = {
    MARKER_29A_FF_PRIZE, ACTOR_3C7_FF_PRIZE_GRUNTY_DOLL, ASSET_560_MODEL_FF_PRIZE_GRUNTY_DOLL,
    0x3, D_80394BE0,
    func_8039217C, actor_update_func_80326224, actor_draw,
    0, 0, 1.0f, 0
};
ActorInfo D_80394C70 = {
    MARKER_29A_FF_PRIZE, 0x3C6, 0x34C,
    0x0, D_80394BE0,
    func_8039217C, actor_update_func_80326224, actor_draw,
    0, 0, 3.0f, 0
};
