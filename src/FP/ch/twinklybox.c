...
void chTwinklyBox_completeMinigame(ActorMarker *marker){
    ...
    timedFunc_set_1(2.3f, (GenFunction_1)chTwinklyBox_destroyBox, (s32)this->marker);
...
void chTwinklyBox_update(Actor *this){
    ...
    switch (this->state)
    {
    case 1: //L8038D89C, before standing nearby box
    ...
    case 2: //L8038D91C, shaking before getting hit open
    ...
    case 3: //L8038DA24, after hitting box
        if(actor_animationIsAt(this, 0.3f))
            chTwinklyBox_openBox(this);
        
        if(actor_animationIsAt(this, 0.999f))
            __spawnQueue_add_1((GenFunction_1)chTwinklyBox_spawnTwinkly, (s32)this->marker);
        ...
        __spawnQueue_add_1((GenFunction_1)chTwinklyBox_spawnSecondAndThirdMuncher, (s32)this->marker);
        this->lifetime_value = 0.0f;
        func_80347A14(0);
        func_802FAD64(ITEM_14_HEALTH);
        break;
    
    case 4: //L8038DB18, winning or losing minigame
        ...
        if(item_getCount(ITEM_24_TWINKLY_SCORE) == 0){
            ...
            timedFunc_set_1(1.3f, (GenFunction_1)chTwinklyBox_completeMinigame, (s32)this->marker);
