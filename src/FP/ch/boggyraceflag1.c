...
ActorInfo D_80391C18 = { 
    MARKER_125_BOGGY_RACE_FLAG, ACTOR_161_BOGGY_RACE_FLAG, ASSET_38B_MODEL_BOGGY_RACE_FLAG, 
    0x1, D_80391C00, 
...
bool func_80387EE4(Actor *this) {
    ...
    temp_f0 = ((temp_f20 * player_pos[0]) + (temp_f22*player_pos[2]));
    sp34 = ((player_pos[0] - this->position[0])*(this->unk1C[0] - this->position[0])) + ((player_pos[2] - this->position[2])*(this->unk1C[2] - this->position[2]));
