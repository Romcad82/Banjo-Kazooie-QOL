...
Struct_B5040 D_80370A20[] = {
    ...
    {VOLATILE_FLAG_15_SANDCASTLE_UNLOCK_ALL_CAULDRONS,                  40},
    ...
    {VOLATILE_FLAG_C6_SANDCASTLE_REPLAY_FURNACE_FUN, FILEPROG_10B_SANDCASTLE_REPLAY_FURNACE_FUN},
    {VOLATILE_FLAG_C7_SANDCASTLE_FINAL_BOSS_REMATCH, FILEPROG_10C_SANDCASTLE_FINAL_BOSS_REMATCH},
 #endif
#else
...
void saveData_load(SaveData *savedata){
 ...
 #ifdef ADDITIONAL_CHEATS
    volatileFlag_set(VOLATILE_FLAG_C6_SANDCASTLE_REPLAY_FURNACE_FUN, fileProgressFlag_get(FILEPROG_10B_SANDCASTLE_REPLAY_FURNACE_FUN));
    volatileFlag_set(VOLATILE_FLAG_C7_SANDCASTLE_FINAL_BOSS_REMATCH, fileProgressFlag_get(FILEPROG_10C_SANDCASTLE_FINAL_BOSS_REMATCH));
 #endif
    volatileFlag_set(VOLATILE_FLAG_65_CHEAT_ENTERED, fileProgressFlag_get(FILEPROG_123_CHEAT_ENTERED));
#else
