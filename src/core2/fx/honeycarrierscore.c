...
void fxhoneycarrierscore_draw(s32 arg0, struct8s *arg1, Gfx **arg2, Mtx **arg3, Vtx **arg4){
    ...
    if (D_8036A010 != 0) {
        ...
        for(sp134 = 0; sp134 < ((sp118)? ((D_8036A014 != 0) ? 2 : 1) : 6); sp134++){
            ...
            core1_3250_guScale(*arg3, D_803815E0, D_803815E0, D_803815E0);
            gSPMatrix((*arg2)++, OS_K0_TO_PHYSICAL((*arg3)++), G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW);
            guTranslate(*arg3, -sp128 * 4.0f, -sp124 * 4.0f, 0.0f);
            gSPMatrix((*arg2)++, OS_K0_TO_PHYSICAL((*arg3)++), G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW);
                ...
                case 1://L802FEB70
                    ...
                    if(D_803815C8 < 0.0f){
                        ...
                        if (is_qol_feature_enabled(QOL_ID_HEALTH_SYSTEM_REWORK)) {
                            timedFunc_set_2(1.25f, (GenFunction_2)item_set, ITEM_14_HEALTH, (item_getCount(ITEM_15_HEALTH_TOTAL) + 1 + (s32)(fileProgressFlag_get(FILEPROG_B9_DOUBLE_HEALTH))));
                        } else {
