...
f32 ml_vec3f_distance_to_point(f32 arg0[3], f32 arg1[3], f32 arg2[3]);
...
f32 ml_clamp_abs_f(f32 arg0, f32 arg1);
...
void ml_project_point_onto_vecf3(f32 a0[3], f32 a1[3], f32 a2[3], f32 a3[3]);
