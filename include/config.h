 ...
 * NOTE: Must be on so NOTE_SAVING and JINJO_SAVING can save properly (Value must be at least 0xF0 to work with both defines).
 * Note: Minimum size is 0x8 (Don't make value less than 0x70 if you don't change or remove any of the vanilla game save data).
 *       Default size is 0x70, if left undefined.
...
/**
 * Notes become a permanent collectible. They won't respawn when you die or leave the level. Some game logic has been altered to accommodate this change.
 *
 * Note: SAVE_FILE_DATA_SIZE must be on to save properly (Needs at least 0x78 bytes of additional data added to the default SAVE_FILE_DATA_SIZE to work).
 */
#define NOTE_SAVING

/**
 * Jinjos become a permanent collectible. They won't respawn when you die or leave the level. Some game logic has been altered to accommodate this change.
 ...
 *
 * Note: SAVE_FILE_DATA_SIZE must be on to save properly (Needs at least 0x10 bytes of additional data added to the default SAVE_FILE_DATA_SIZE to work).
 */
#define JINJO_SAVING
 ...
 * Max health cheat is also updated to give 9 bars of health and fixes a bug where it temporarily removes Double Health.
 *
 ...
 * Can only use it if you're in a level.
 *
 ...
 * Also resets the cheat progress so you can reinput the cheat right away, instead of having to leave and reenter the sandcastle.
 */
