...
enum file_progress_e {
    ...
    FILEPROG_124_SANDCASTLE_UNLOCK_ALL,
    FILEPROG_125_SANDCASTLE_RAISE_WATER_LEVEL,
    FILEPROG_126_SANDCASTLE_OPEN_DOOR_EIGHT,
    FILEPROG_127_SANDCASTLE_PUZZLE_COMPLETE_DOG
#else
    FILEPROG_123_CHEAT_ENTERED
#endif
};
