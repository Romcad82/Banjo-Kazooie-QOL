...
enum file_progress_e {
    ...
    FILEPROG_5E_TTC_PUZZLE_PIECES_PLACED = 0x5E, //2 bit
...
#endif
#ifdef ADDITIONAL_CHEATS
    VOLATILE_FLAG_15_SANDCASTLE_UNLOCK_ALL_CAULDRONS,
#else
...
#ifdef ADDITIONAL_CHEATS
    VOLATILE_FLAG_1D_SANDCASTLE_LEARN_ALL_ABILITIES = 0x1D,
#else
...
#ifdef ADDITIONAL_CHEATS
    VOLATILE_FLAG_79_SANDCASTLE_UNLOCK_ALL,
    VOLATILE_FLAG_7A_SANDCASTLE_RAISE_WATER_LEVEL,
...
#endif
    VOLATILE_FLAG_B2_HAS_COLLECTED_CATERPILLAR, // ccw related
...
#ifdef ADDITIONAL_CHEATS
    VOLATILE_FLAG_C6_SANDCASTLE_REPLAY_FURNACE_FUN,
    VOLATILE_FLAG_C7_SANDCASTLE_FINAL_BOSS_REMATCH,
#endif
...
enum level_flags_e
{
    ...
    LEVEL_FLAG_E_CC_MUTIE_SNIPPETS,

    LEVEL_FLAG_10_CCW_BREAK_ZUBBA_DOOR = 0x10,
    ...
    LEVEL_FLAG_1C_MM_OPEN, // See jigsawpicture.c
    ...
    LEVEL_FLAG_25_CCW_GNAWTY_JIGGY_COLLECTED,
    LEVEL_FLAG_26_FP_WALRUS_JIGGY_DROPPED,
    LEVEL_FLAG_27_RBB_UNKNOWN,
    LEVEL_FLAG_28_RBB_UNKNOWN,
    LEVEL_FLAG_29_FP_XMAS_TREE_COMPLETE,
    ...
    LEVEL_FLAG_31_FP_WOZZA_WALRUS_TALKED,
    LEVEL_FLAG_32_FP_WOZZA_BEAR_TALKED,
    LEVEL_FLAG_33_MMM_UNKNOWN,
    LEVEL_FLAG_34_UNKNOWN,

    LEVEL_FLAG_35_UNKNOWN,
...
enum sfx_e
{
    ...
    SFX_3E_POOP_NOISE, 
    // higher pitch
    SFX_3F_CAULDRON_SQUEAK_1, 
    // lower pitch
    SFX_40_CAULDRON_SQUEAK_2, 
    // waking up
    SFX_41_MUMBO_ERGHHH, 
    // short and dull
    SFX_42_KAZOOIE_RAH, 
    ...
    SFX_415_XMAS_LIGHTS_FLICKERING,
    SFX_416_ELECTRIC_ZAP,
...
enum mumbotoken_e
{
    ...
    MUMBOTOKEN_3D_MMM_INSIDE_LOGGO,
#else
...
#ifdef VANILLA_SPECIFIC_BUG_AND_OVERSIGHT_FIXES
    ,
    MUMBOTOKEN_74_MMM_INSIDE_BARREL_IN_CELLAR
#endif
};
...
enum actor_e
{
    ...
    ACTOR_1E_LEAKY,
    ACTOR_1F_UNUSED, // Maybe was supposed to be Termite Transformation?
    ACTOR_20_TRANSFORM_PUMPKIN,
    ACTOR_21_TRANSFORM_CROC,
    ACTOR_22_TRANSFORM_WALRUS,
    ACTOR_23_TRANSFORM_BEE,
    ...
    ACTOR_3A_MOTZHAND,
    ACTOR_3B_CLANKER_DIALOG_TRIGGER,
    ACTOR_3C_CC_KEY,
    ...
    ACTOR_4C_STEAM,
    ACTOR_4D_STEAM_2,
    ACTOR_4E_WADING_BOOTS_TOUCH_SPARKLE,
    ACTOR_4F_TURBO_TRAINERS_TOUCH_SPARKLE,
    ACTOR_50_HONEYCOMB,
    ACTOR_51_MUSIC_NOTE,
    ACTOR_52_BLUE_EGG,
    ACTOR_53_RED_ARROW,
    ...
    ACTOR_8E_CONCERT_BANJO = 0x8E,

    ACTOR_92_CONCERT_TOOTY = 0x92,
    ACTOR_93_INTRO_N64_CUBE,
    ACTOR_94_INTRO_RARE_LOGO,
    
    ACTOR_9B_CONCERT_BULL = 0x9B,
    ACTOR_9C_CONCERT_FROG,
    ACTOR_9D_CONCERT_BIGBUTT,

    ACTOR_A2_FIRE_SPARKLE = 0xA2,

    ACTOR_A6_CONCERT_ANT = 0xA6,
    ACTOR_A7_BBQ_MUMBO,
    ACTOR_A8_BBQ_GRILL_AND_FISH,
    ACTOR_A9_TOOTY_REFLECTION,
    ACTOR_AA_DINGPOT_TOP,
    ACTOR_AB_GRUNTILDA_ARMS,

    ACTOR_AF_GREEN_FLOOR_MIST = 0xAF,
    
    ACTOR_BC_BANJOS_CURTAINS = 0xBC,
    ACTOR_BD_BANJOS_HOUSE_DOOR,
    ...
    ACTOR_106_UNKNOWN,
    ACTOR_107_UNKNOWN,
    ACTOR_108_MODEL_PLAYER_SHADOW,
    ACTOR_109_SHACK_DOOR,
    ACTOR_10A_MANSION_DOOR,
    ACTOR_10B_CELLAR_HATCH,
    ACTOR_10C_CHURCH_GATE_LEFT_LOCK,
    ACTOR_10D_HEDGE_GATE_RIGHT_LOCK_1,
    ACTOR_10E_BLUBBER_SHIP_TOP_HATCH,
    ...
    ACTOR_11B_RUBEE,
    ACTOR_11C_HISTUP,
    ACTOR_11D_RUBEES_EGG_POT,
    ACTOR_11E_GRABBA_SHADOW,
    ...
    ACTOR_14B_TTC_BLUBBER_UNKNOWN,

    ACTOR_14D_BGS_ELEVATED_WALKWAY_JIGGY_LOCATION = 0x14D,
    ...
    ACTOR_162_BOGGY_RACE_FLAG,
    ACTOR_163_BAT,
    ACTOR_164_COLLYWOBBLE_THE_CAULIFLOWER_A,
    ACTOR_165_BAWL_THE_ONION_A,
    ACTOR_166_TOPPER_THE_CARROT_A,
    ACTOR_167_ATTACK_TUTORIAL,
    ACTOR_168_CCW_WINTER_SWITCH,
    ACTOR_169_CCW_WINTER_SEASON_DOOR,
    ACTOR_16A_CCW_AUTUMN_SWITCH,
    ACTOR_16B_CCW_AUTUMN_SEASON_DOOR,
    ACTOR_16C_CCW_SUMMER_SWITCH,
    ACTOR_16D_CCW_SUMMER_SEASON_DOOR,
    ACTOR_16E_UNKNOWN,
    ACTOR_16F_QUARRIE,

    ACTOR_172_RBB_EGG_TOLL = 0x172,
    ACTOR_173_RBB_CAGE_UP_SWITCH,
    ACTOR_174_RBB_TNT_DOWN_SWITCH,
    ACTOR_175_RUSTY_BUCKET_REAR_PROPELLER,
    ACTOR_176_RBB_GREEN_PROPELLOR_SWITCH,
    ...
    ACTOR_17B_RBB_SMALL_COG,
    ACTOR_17C_RBB_MEDIUM_COG,
    ACTOR_17D_RBB_LARGE_COG,
    ACTOR_17E_RBB_SPINNING_SINGLE_PIPE_2,
    ACTOR_17F_RBB_SPINNING_DOUBLE_PIPE_1,
    ACTOR_180_RBB_SPINNING_DOUBLE_PIPE_2,
    ...
    ACTOR_18F_RBB_HONEYCOMB_SWITCH = 0x18F,

    ACTOR_191_X_BARREL_TOP = 0x191,

    ACTOR_198_BANJOS_BED = 0x198,
    ACTOR_199_BANJOS_CHAIR,
    ACTOR_19A_BANJOS_STOVE,
    ACTOR_19B_MUMBOS_HAND_WITH_PICTURE,
    ACTOR_19C_MODEL_THE_END_SIGN = 0x19C,

    ACTOR_1BB_ENGINE_ROOM_PROPELLOR_1 = 0x1BB,
    ACTOR_1BC_ENGINE_ROOM_PROPELLOR_2,
    ACTOR_1BD_ENGINE_ROOM_PROPELLOR_3,
    ACTOR_1BE_RBB_GREY_PROPELLOR_SWITCH,
    ACTOR_1BF_WHISTLE_SWITCH_1,
    ACTOR_1C0_WHISTLE_SWITCH_2,
    ACTOR_1C1_WHISTLE_SWITCH_3,
    ACTOR_1C2_WHISTLE_1,
    ACTOR_1C3_WHISTLE_2,
    ACTOR_1C4_WHISTLE_3,
    ACTOR_1C5_WHISTLE_CTRL,
    ACTOR_1C6_GRIMLET,
    ACTOR_1C7_ANCHOR_SWITCH,
    ACTOR_1C8_SNORKEL,
    ACTOR_1C9_ANCHOR,
    ACTOR_1CA_RAREWARE_FLAG,

    ACTOR_1CC_GRILLE_CHOMPA = 0x1CC,
    ACTOR_1CD_UNKNOWN,
    ACTOR_1CE_UNKNOWN,
    ACTOR_1CF_UNKNOWN,
    ACTOR_1D0_UNKNOWN,
    ...
    ACTOR_1DC_BANJO_KAZOOIE_SIGN,
    ACTOR_1DD_COPYRIGHT_OVERLAY,
    ACTOR_1DE_PRESS_START_OVERLAY,
    ACTOR_1DF_NO_CONTROLLER_OVERLAY,
    ACTOR_1E0_JIGSAW_PUZZLE,
    ACTOR_1E1_IRON_GATE_NO_LOCK,
    ACTOR_1E2_CCW_SPRING_SWITCH,
    ACTOR_1E3_CCW_SPRING_SEASON_DOOR,
    ACTOR_1E4_TOOTS,
    ACTOR_1E5_UNKNOWN,
    ...
    ACTOR_1FB_BGS_MAZE_SWITCH,
    ACTOR_1FC_BGS_MAZE_JIGGY_LOCATION,
    ACTOR_1FD_MMM_CLOCK_SWITCH,
    ACTOR_1FE_HEDGE_GATE_RIGHT_LOCK_2,
    ACTOR_1FF_SPENT_RED_FEATHER,
    ACTOR_200_SPENT_GOLD_FEATHER,

    ACTOR_203_NOTE_DOOR = 0x203,
    ...
    ACTOR_211_TTC_ENTRANCE_CHEST_LID,
    ACTOR_212_CC_ENTRANCE_BARS,
    ACTOR_213_GL_BGS_PUZZLE_GRATE,
    ACTOR_214_RAISE_GRATE_TO_BGS_PUZZLE_SWITCH,
    ACTOR_215_GL_CC_ENTRANCE_LONG_PIPE_GREEN,
    ACTOR_216_GL_CC_ENTRANCE_LONG_PIPE_BLUE,
    ACTOR_217_RAISE_PIPE_TO_CC_ENTRANCE_SWITCH,
    ACTOR_218_GL_CC_ENTRANCE_SHORT_PIPE,
    ACTOR_219_RAISE_PIPE_TO_BRENTILDA_SWITCH,
    ACTOR_21A_IRON_BARS_UNDER_GRUNTY_STATUE,
    ACTOR_21B_GRUNTY_STATUE_BREAKABLE_HAT_TOP,
    ACTOR_21C_CABIN_CLOSET_DOOR,
    ACTOR_21D_ENGINE_ROOM_DOOR,
    ACTOR_21E_GRATE_TO_LEVEL_3_WATER_SWITCH,
    ACTOR_21F_GRATE_BETWEEN_MMM_AND_RBB_PUZZLES,
    ACTOR_220_GRATE_TO_RBB_PUZZLE,
    ACTOR_221_LEVEL_1_WATER_SWITCH,
    ACTOR_222_LEVEL_2_WATER_SWITCH,
    ACTOR_223_LEVEL_3_WATER_SWITCH,
    ACTOR_224_ICE_BALL_TO_CHEATO,
    ACTOR_225_RAREWARE_BOX,
    ACTOR_226_GV_ENTRANCE,
    ACTOR_227_GLASS_EYE,
    ACTOR_228_MMM_ENTRANCE_DOOR, //MMM ENTRANCE DOOR???

    ACTOR_23C_CCW_PUZZLE_SWITCH = 0x23C,

    ACTOR_230_BREAKABLE_FLOOR_COBWEB = 0x230,
    ACTOR_231_BREAKABLE_WALL_COBWEB,

    ACTOR_233_CCW_MUMBOS_HUT = 0x233,
    ACTOR_234_CCW_ENTRANCE_DOOR,
    ACTOR_235_FP_ENTRANCE_DOOR_LEFT,
    ACTOR_236_FP_ENTRANCE_DOOR_RIGHT,
    ACTOR_237_CCW_WITCH_SWITCH,

    ACTOR_239_FP_WITCH_SWITCH = 0x239,
    ACTOR_23A_GL_ADVENT_CALENDAR_HATCH_DOOR,
    ACTOR_23B_WARP_CAULDRON,
    
    ACTOR_23D_MUMBO_SWITCH = 0x23D,
    ACTOR_23E_GL_WOODEN_COFFIN_NO_LID,
    ACTOR_23F_CRACKED_SKYLIGHT,

    ACTOR_242_FF_TELEPORT_PAD = 0x242,
    ACTOR_243_GV_SNS_CHAMBER_DOOR,
    ACTOR_244_GV_SNS_SARCOPHAGUS,
    ACTOR_245_GV_SNS_SWITCH,
    ACTOR_246_FLIGHT_PAD_SWITCH,
    ACTOR_247_LAIR_SWITCH_FLIGHT_PAD,
    ACTOR_248_SHOCK_JUMP_PAD_SWITCH,
    ACTOR_249_LAIR_SWITCH_SHOCK_JUMP_PAD,

    ACTOR_255_GL_SARCOPHAGUS = 0x255,
    ACTOR_256_GV_WITCH_SWITCH,
    ACTOR_257_BGS_WITCH_SWITCH,
    ACTOR_258_CRYPT_COFFIN_LID,
    ACTOR_259_GL_GRUNTY_FLOOR_PICTURE_EYE_1,
    ACTOR_25A_GL_GRUNTY_FLOOR_PICTURE_EYE_2,
    ACTOR_25B_CC_WITCH_SWITCH,
    ACTOR_25C_SHARKFOOD_ISLAND,
    ACTOR_25D_ICE_KEY,
    ACTOR_25E_SNS_EGG,
    ACTOR_25F_CCW_UNKNOWN_NABNUT_WINDOW,
    ACTOR_260_CCW_UNKNOWN_NABNUT_WINDOW,
    ACTOR_261_CCW_AUTUMN_NABNUT_WINDOW,
    ACTOR_262_CCW_WINTER_NABNUT_WINDOW,
    ACTOR_263_SUNNY_LIFEBOAT,
    ACTOR_264_SHADOW_LIFEBOAT,
    ACTOR_265_DINING_DOOR,
    ACTOR_266_SHIP_SHADOW_WINDOW,
    ACTOR_267_SHIP_SUNNY_WINDOW,
    ...
    ACTOR_285_JINXY_HEAD_SANDYBUTT_1,
    ACTOR_286_JINXY_HEAD_SANDYBUTT_2,
    ACTOR_287_JINXY_HEAD_SANDYBUTT_3,

    ACTOR_289_BETA_VENT = 0x289,
    ACTOR_28A_CLANKER_WHIPCRACK,
    ACTOR_28B_SOUND_SOURCE,

    ACTOR_28F_BETA_VENT = 0x28F,
    ACTOR_290_CLANKER_SAWBLADE_PROPELLOR_7,
    ...
    ACTOR_296_BELL_BUOY,
    ACTOR_297_ROWBOAT,
    ACTOR_298_ZUBBA_DOOR_SUMMER,
    ACTOR_299_ZUBBA_HONEY_LUMP,
    ACTOR_29A_ZUBBA_DOOR_AUTUMN,
    ACTOR_29B_ZUBBA,
    ACTOR_29C_ZUBBA_DOCILE,
    ACTOR_29D_CCW_BEANSTALK,
    ACTOR_29E_CCW_GOBI,
    ACTOR_29F_CLUCKER,
    ACTOR_2A0_EAGLE_EGG,
    ACTOR_2A1_EEYRIE_BABY,
    ACTOR_2A2_CATERPILLAR,
    ACTOR_2A3_EEYRIE_ADULT,
    ACTOR_2A4_BOOM_BOX_SLOW,
    ACTOR_2A5_BOOM_BOX_MINIGAME_CTRL,
    ACTOR_2A6_NABNUT_SPRING,
    ACTOR_2A7_NABNUT_FULL_BELLY,
    ACTOR_2A8_NABNUT,
    ACTOR_2A9_ACORN,
    ACTOR_2AA_GNAWTY_SWIMMING,
    ACTOR_2AB_GNAWTY_SUMMER,
    ACTOR_2AC_GNAWTY_BOULDER,
    ACTOR_2AD_BOSS_BOOMBOX_CTRL,
    ACTOR_2AE_LEAF_EMITTER_CCW_AUTUMN,
    ACTOR_2AF_LEAF_EMITTER_CCW_HUB,
    ACTOR_2B0_RAIN_EMITTER_CCW_SPRING,
    ACTOR_2B1_RAIN_EMITTER_CCW_HUB,
    ACTOR_2B2_SNOW_EMITTER_CCW_WINTER,
    ACTOR_2B3_SNOW_EMITTER_CCW_HUB,
    ACTOR_2B4_BOTTLES_BONUS_BANJO_HAND,
    ACTOR_2B5_UNKNOWN,

    ACTOR_2D8_TWO_ICE_POLES_NEAR_CHEATO_3 = 0x2D8,
    ACTOR_2D9_UNKNOWN,
    ACTOR_2DA_UNKNOWN,
    ACTOR_2DB_DINGPOT,
    ACTOR_2DC_GNAWTYS_SHELVES,
    ACTOR_2DD_GNAWTYS_BED,
    ACTOR_2DE_GNAWTYS_DEN,
    ACTOR_2DF_LIGHTHOUSE_B,
    ACTOR_2E0_TTC_STAIRS_1,
    ACTOR_2E1_TTC_STAIRS_2,
    ACTOR_2E2_LIGHTHOUSE_A,
    ACTOR_2E3_LEVEL_ENTRY_SIGNS,
    ACTOR_2E4_WORLD_EXIT_PAD,
    ACTOR_2E5_LARGE_DOOR_TO_FINAL_BATTLE,
    ACTOR_2E6_NABNUT_DOOR,
    ACTOR_2E7_WHIPCRACK_ROOM_DOOR,
    ACTOR_2E8_WINDOW,
    ACTOR_2E9_WIDE_WINDOW,
    ACTOR_2EA_TALL_WINDOW,

    ACTOR_2F4_FISHBOWL = 0x2F4,
    ACTOR_2F5_CUCKOO_CLOCK,

    ACTOR_2FF_GREEN_FOG_OUTSIDE_TOWER = 0x2FF,
    ACTOR_300_BIKINI_GIRL,

    ACTOR_30B_DEAD_BEANSTALK = 0x30B,
    ACTOR_30C_SNORE_Z,
    ACTOR_30D_BOOM_BOX_FAST,
    ACTOR_30E_CUTSCENE_ADULT_EYRIE,
    ACTOR_30F_WHIPCRACK,
    ACTOR_310_NABNUT_HOUSE_PILE_OF_ACORNS,
    ACTOR_311_PINK_SQUIRREL,
    ACTOR_312_NABNUT_BEDSHEETS,
    ACTOR_313_NABNUT_BED,
    ACTOR_314_NABNUT_IN_AUTUMN_HOUSE,
    ACTOR_315_NABNUT_EATING_ACORNS,
    ACTOR_316_UNKNOWN,
    ACTOR_317_UNKNOWN,
    ACTOR_318_CCW_UNKNOWN = 0x318,
    ACTOR_319_GV_MAZE_CTRL,
    ACTOR_31A_INDOORS_GNAWTY,
    ACTOR_31B_SPINNING_SINGLE_PIPE_SFX_CTRL,
    ACTOR_31C_DOUBLE_SINGLE_PIPE_SFX_CTRL,
    ACTOR_31D_SANDYBUTT_PYRAMID,
    ACTOR_31E_PALM_TREE,
    ...
    ACTOR_36D_COLLYWOBBLE_B,
    ACTOR_36E_BAWL_THE_ONION_B,
    ACTOR_36F_TOPPER_THE_CARROT_B,
    ACTOR_370_GOLD_FEATHER,
    ...
    ACTOR_3A9_JINJONATOR_STATUE_BASE,
    ...
    ACTOR_3BD_SM_BRIDGE_CHECKSUM_TRIGGER = 0x3BD,
...
enum bs_e {
    ...
    BS_50_CLIMB_MOVE,
    BS_51_CLIMB_EXIT,
    BS_52_SURF, //tumblar??? a.k.a bssurf
    BS_53_TIMEOUT_BANJO,    
    BS_54_SWIM_DIE,
    BS_55_LONGLEG_SLIDE,
    BS_56_RECOIL,
    ...
    BS_69_WALRUS_JUMP,
    BS_6A_WALRUS_FALL,
    BS_6B_BEE_LOCKED, //[107] = "Locked", -- Bee, Mumbo Transform Cutscene
    BS_6C_WALRUS_OW,
    BS_6D_WALRUS_DIE,
    BS_6E_CROC_BITE,
    BS_6F_CROC_EAT_BAD,
    BS_70_CROC_EAT_GOOD,
    BS_71_BTROT_FALL,
    BS_72_SPLAT, // Getting up after fall damage
    BS_73_UNKNOWN, // locked_cutscene
    BS_74_UNKNOWN, // locked jiggypad, xform, bottles
    BS_75_UNKNOWN, // locked bottles
    BS_76_BFLY_LOCKED,
    BS_77_SWIM_LOOKAT_DRONE,
    BS_78_DIVE_LOOKAT_DRONE,
    BS_79_BTROT_LOCKED,
    BS_7A_WALK_MUD,
    BS_7B_BTROT_OW,
    BS_7C_SLED,
    ...
    BS_8C_BEE_FLY,
    BS_8D_CROC_LOCKED,
    BS_8E_ANT_LOCKED, // "Locked", -- Jiggy podium, Bottles' text outside Mumbo's
    BS_8F_PUMPKIN_LOCKED,
...
enum bgs_specific_flags {
    BGS_SPECIFIC_FLAG_1 = 1, // WALKWAY_JIGGY
    BGS_SPECIFIC_FLAG_2_WALKWAY_JIGGY_RESET,
    BGS_SPECIFIC_FLAG_3_WALKWAY_JIGGY_TIMER_RUNNING,
    BGS_SPECIFIC_FLAG_4_WALKWAY_JIGGY,
    BGS_SPECIFIC_FLAG_5_WALKWAY_JIGGY_SWITCH_PRESSED,
    BGS_SPECIFIC_FLAG_6_MR_VILE,
    BGS_SPECIFIC_FLAG_7, // WALKWAY_JIGGY
    BGS_SPECIFIC_FLAG_8, // WALKWAY_JIGGY
    BGS_SPECIFIC_FLAG_9_MAZE_JIGGY_SWITCH_PRESSED,
    BGS_SPECIFIC_FLAG_A, // MAZE_JIGGY
    BGS_SPECIFIC_FLAG_B_MAZE_JIGGY_RESET,
    BGS_SPECIFIC_FLAG_C_MAZE_JIGGY_TIMER_RUNNING,
    BGS_SPECIFIC_FLAG_D_MAZE_JIGGY,
    BGS_SPECIFIC_FLAG_E_UNUSED,
    BGS_SPECIFIC_FLAG_F_UNUSED,
    BGS_SPECIFIC_FLAG_10_FROG_MINIGAME_FIRST_MET,
    BGS_SPECIFIC_FLAG_11_UNUSED,
    BGS_SPECIFIC_FLAG_12_FROG_MINIGAME_BATTLE_ACTIVE
};

enum fp_specific_flags {
    FP_SPECIFIC_FLAG_0_XMAS_TREE_LIGHTS_ON = 0,
    FP_SPECIFIC_FLAG_1_UNKNOWN,
    FP_SPECIFIC_FLAG_2_XMAS_TREE_SWITCH,
    FP_SPECIFIC_FLAG_3_XMAS_TREE_STAR_COMPLETE,
    FP_SPECIFIC_FLAG_4_UNKNOWN,
    FP_SPECIFIC_FLAG_5_WALRUS_RACE_FAILED,
    FP_SPECIFIC_FLAG_6_BANJO_RACE_FAILED,
    FP_SPECIFIC_FLAG_7_WOZZA_FIRST_CONTACT,
    FP_SPECIFIC_FLAG_8_WOZZA_MET_WALRUS,
    FP_SPECIFIC_FLAG_9_UNKNOWN,
    FP_SPECIFIC_FLAG_A_FIRST_TWINKLY_EATEN,
    FP_SPECIFIC_FLAG_B_UNKNOWN,
    FP_SPECIFIC_FLAG_C_UNKNOWN,
...
enum rbb_main_specific_flags {
    RBB_MAIN_SPECIFIC_FLAG_0_PROPELLER,
    RBB_MAIN_SPECIFIC_FLAG_1_WHISTLE_SWITCH_1,
    RBB_MAIN_SPECIFIC_FLAG_2_WHISTLE_SWITCH_2,
    RBB_MAIN_SPECIFIC_FLAG_3_WHISTLE_SWITCH_3,
    RBB_MAIN_SPECIFIC_FLAG_4_ANCHOR_LIFTING,

    RBB_MAIN_SPECIFIC_FLAG_8_UNK = 8
};

enum rbb_boat_room_specific_flags {
    RBB_BOAT_ROOM_SPECIFIC_FLAG_0_HONEYCOMB_SPAWNED
};
...
enum ccw_zubba_specific_flags {
    CCW_ZUBBA_SPECIFIC_FLAG_7_SPRING_DIALOG = 0x7,
    CCW_ZUBBA_SPECIFIC_FLAG_8_AUTUMN_DIALOG
};

enum ccw_winter_specific_flags {
    CCW_WINTER_SPECIFIC_FLAG_5_EEYRIE_ADULT = 0x5,
    CCW_WINTER_SPECIFIC_FLAG_6_CUTSCENE_EEYRIE_ADULT
};
...
enum asset_e
{
    ...
    ASSET_3_ANIM_BSWALK,
    /*stub*/ ASSET_4_ANIM_stub,
    ASSET_5_ANIM_BSPUNCH,
    /*stub*/ ASSET_6_ANIM_stub,
    ASSET_7_ANIM_BSBTROT_EXIT,
    ASSET_8_ANIM_BSJUMP,
    ASSET_9_ANIM_BSDIE,
    ASSET_A_ANIM_BSCLIMB_MOVE,
    ASSET_B_ANIM_BSWALK_MUD,
    ASSET_C_ANIM_BSWALK_RUN,
    /*stub*/ ASSET_D_ANIM_stub,
    ASSET_E_ANIM_BSTURN,
    ASSET_F_ANIM_BSREBOUND,
    ASSET_10_ANIM_BIGBUTT_RUN,
    ASSET_11_ANIM_BSWHIRL_WALK,
    /*stub*/ ASSET_12_ANIM_stub,
    /*stub*/ ASSET_13_ANIM_stub,
    /*stub*/ ASSET_14_ANIM_stub,
    ASSET_15_ANIM_BSBTROT_WALK,
    ...
    /*stub*/ ASSET_1E_ANIM_stub,
    /*stub*/ ASSET_1F_ANIM_stub,
    /*stub*/ ASSET_20_ANIM_stub,
    ASSET_21_ANIM_BIGBUTT_SLIDE,
    ASSET_22_ANIM_BSWHIRL_EXIT,
    ASSET_23_ANIM_BSWONDERWING_IDLE,
    ASSET_24_ANIM_CLAM_HOP,
    /*stub*/ ASSET_25_ANIM_stub,
    ASSET_26_ANIM_BSBTROT_IDLE,
    ...
    /*stub*/ ASSET_37_ANIM_stub,
    ASSET_38_ANIM_BSBFLY,
    ASSET_39_ANIM_BSSWIM_MOVE,
    /*stub*/ ASSET_3A_ANIM_stub,
    /*stub*/ ASSET_3B_ANIM_stub,
    ASSET_3C_ANIM_BSSWIM_DIVE_ENTER,
    ...
    /*stub*/ ASSET_46_ANIM_stub,
    /*stub*/ ASSET_47_ANIM_stub,
    ASSET_48_ANIM_BSBSHOCK_CHARGE,
    ASSET_49_ANIM_BSBSHOCK_JUMP,
    /*stub*/ ASSET_4A_ANIM_stub,
    ASSET_4B_ANIM_BSBFLIP_ENTER,
    ASSET_4C_ANIM_BSBFLIP_HOLD,
    ASSET_4D_ANIM_BSOW,
    ASSET_4E_ANIM_MUD_HUT_SMASH,
    ASSET_4F_ANIM_BSTWIRL,
    /*stub*/ ASSET_50_ANIM_stub,
    ...
    ASSET_62_ANIM_GRUBLIN_IDLE_WALK,
    ASSET_63_ANIM_GRUBLIN_CHASE,
    ASSET_64_ANIM_GRUBLIN_ALERT,
    ...
    /*stub*/ ASSET_74_ANIM_stub,
    /*stub*/ ASSET_75_ANIM_stub,
    ASSET_76_ANIM_JIGSAWDANCE_HOLD,
    ASSET_77_ANIM_BSTIMEOUT,
    ASSET_78_ANIM_SNACKER_SWIMMING,
    ASSET_79_ANIM_unk, // Mumbo Concert Playing Instrument
    ASSET_7A_ANIM_unk, // Banjo Concert Angry
    ASSET_7B_ANIM_unk, // Banjo Concert Play
    ASSET_7C_ANIM_unk, // Banjo Concert End
    ASSET_7D_ANIM_unk, // Tooty Concert Start
    ASSET_7E_ANIM_unk, // Banjo Concert Start
    ASSET_7F_ANIM_unk, // Concert Cutscene
    ASSET_80_ANIM_unk, // Concert Timer
    ASSET_81_ANIM_unk, // Concert Unknown (0x81)
    ASSET_82_ANIM_unk, // Mumbo Concert Dance
    ASSET_83_ANIM_unk, // Tooty Concert Dance
    ASSET_84_ANIM_unk, // Tooty Hopping
    ASSET_85_ANIM_unk, // ???
    /*stub*/ ASSET_86_ANIM_stub,
    /*stub*/ ASSET_87_ANIM_stub,
    /*stub*/ ASSET_88_ANIM_stub,
    /*stub*/ ASSET_89_ANIM_stub,
    /*stub*/ ASSET_8A_ANIM_stub,
    /*stub*/ ASSET_8B_ANIM_stub,
    ASSET_8C_ANIM_unk, //Rareware Logo Falling
    /*stub*/ ASSET_8D_ANIM_stub,
    /*stub*/ ASSET_8E_ANIM_stub,
    ASSET_8F_ANIM_unk, //Nintendo Logo Walking
    ASSET_90_ANIM_unk, //Nintendo Logo Shrugging
    ASSET_91_ANIM_unk, //Frog Hopping (Concert)
    ASSET_92_ANIM_SHRAPNEL_MOVE,
    ASSET_93_ANIM_unk, //Tooty Running (Concert)
    ASSET_94_ANIM_GRUBLIN_DIE,
    ...
    /*stub*/ ASSET_99_ANIM_stub,
    ASSET_9A_ANIM_GRAVESTONE_IDLE,
    ASSET_9B_ANIM_GRAVESTONE_WALK,
    /*stub*/ ASSET_9C_ANIM_stub,
    ASSET_9D_ANIM_BAT_FLY,
    ...
    /*stub*/ ASSET_AF_ANIM_stub,
    ASSET_B0_ANIM_BSJUMP_FALL,
    ASSET_B1_ANIM_BSCLIMB_IDLE_1,
    ASSET_B2_ANIM_BSCLIMB_IDLE_2,
    ASSET_B3_ANIM_CHUMP_IDLE,
    ASSET_B4_ANIM_CHUMP_ATTACK,
    ASSET_B5_ANIM_BLUBBER_WALK,
    ASSET_B6_ANIM_BLUBBER_CRY,
    ASSET_B7_ANIM_BLUBBER_DANCE,
    ASSET_B8_ANIM_BLUBBER_RUN,
    ASSET_B9_ANIM_BSSWIM_DIE,
    /*stub*/ ASSET_BA_ANIM_stub,
    /*stub*/ ASSET_BB_ANIM_stub,
    ASSET_BC_ANIM_LOCKUP,
    ...
    ASSET_D9_ANIM_unk,
    ASSET_DA_ANIM_unk,
    ASSET_DB_ANIM_FLIBBIT_HOP,
    ASSET_DC_ANIM_GOBI_ROPE_PULLING,
    ASSET_DD_ANIM_GOBI_ROPE,
    /*stub*/ ASSET_DE_ANIM_stub,
    ASSET_DF_ANIM_RUBEE_PET_TOOTS,
    ...
    ASSET_E5_ANIM_unk, // SLAPPA_SHADOW?
    ASSET_E6_ANIM_unk, // SLAPPA_SHADOW?
    ASSET_E7_ANIM_unk, // SLAPPA_SHADOW?
    ASSET_E8_ANIM_unk, // SLAPPA_SHADOW?
    ASSET_E9_ANIM_SLAPPA_RISE,
    ASSET_EA_ANIM_SLAPPA_CHASE,
    ASSET_EB_ANIM_SLAPPA_ATTACK,
    ASSET_EC_ANIM_SLAPPA_GETTING_UP,
    ASSET_ED_ANIM_ANCIENT_ONE,
    ASSET_EE_ANIM_SLAPPA_DIE,
    ASSET_EF_ANIM_SLAPPA_LOWER,
    ASSET_F0_ANIM_MINI_SPHINX_EATING,
    ASSET_F1_ANIM_MAGIC_CARPET,
    /*stub*/ ASSET_F2_ANIM_stub,
    /*stub*/ ASSET_F3_ANIM_stub,
    ASSET_F4_ANIM_GOBI_IDLE,
    ASSET_F5_ANIM_unk,
    ASSET_F6_ANIM_BSSTAND_PULL_KAZOOIE,
    ASSET_F7_ANIM_unk,
    ASSET_F8_ANIM_GOBI_RUNNING,
    ASSET_F9_ANIM_unk,
    ASSET_FA_ANIM_FLIBBIT_IDLE,
    ...
    ASSET_100_ANIM_GOBI_SPIT,
    ASSET_101_ANIM_TANKTUP_IDLE,
    ASSET_102_ANIM_TANKTUP_OW,
    ASSET_103_ANIM_TANKTUP_LEGS_FRONT_LEFT,
    ASSET_104_ANIM_TANKTUP_LEGS_BACK_LEFT,
    ASSET_105_ANIM_TANKTUP_LEGS_FRONT_RIGHT,
    ASSET_106_ANIM_TANKTUP_LEGS_BACK_RIGHT,
    ASSET_107_ANIM_TANKTUP_MOUTH_OPEN,
    ASSET_108_ANIM_SIR_SLUSH_IDLE,
    ASSET_109_ANIM_SIR_SLUSH_ATTACK,
    /*stub*/ ASSET_10A_ANIM_stub,
    ASSET_10B_ANIM_unk,
    ...
    ASSET_110_ANIM_unk,
    ASSET_111_ANIM_unk,
    ASSET_112_ANIM_FLIBBIT_DIE,
    ASSET_113_ANIM_FLIBBIT_DEAD,
    /*stub*/ ASSET_114_ANIM_stub,
    /*stub*/ ASSET_115_ANIM_stub,
    ASSET_116_ANIM_BSCROUCH_NOINPUT,
    ASSET_117_ANIM_unk,
    /*stub*/ ASSET_118_ANIM_stub,
    /*stub*/ ASSET_119_ANIM_stub,
    /*stub*/ ASSET_11A_ANIM_stub,
    ASSET_11B_ANIM_BSTHROW,
    ...
    ASSET_135_ANIM_unk,
    ASSET_136_ANIM_unk,
    ASSET_137_ANIM_GRIMLET_ATTACK,
    ASSET_138_ANIM_ZOOMBOX,
    ASSET_139_ANIM_BOTTLES_EXIT,
    ASSET_13A_ANIM_BOTTLES_ENTER,
    ASSET_13B_ANIM_BOTTLES_IDLE,
    ASSET_13C_ANIM_MOLEHILL_UNKNOWN,
    ASSET_13D_ANIM_MOLEHILL_UNKNOWN,
    ASSET_13E_ANIM_SNORKEL_SWIM,
    ASSET_13F_ANIM_SNORKEL_STUCK,
    ASSET_140_ANIM_RAREWARE_FLAG,
    ASSET_141_ANIM_ANCHOR_LOWERED,
    ASSET_142_ANIM_ANCHOR_RISING,
    ASSET_143_ANIM_SNOWMAN_BUTTON,
    ASSET_144_ANIM_unk,
    ASSET_145_ANIM_unk,
    ASSET_146_ANIM_BOSS_BOOMBOX_APPEAR,
    ASSET_147_ANIM_BOOMBOX_MOVE,
    ASSET_148_ANIM_BOOMBOX_DIE,
    ASSET_149_ANIM_BSSPLAT,
    ASSET_14A_ANIM_BSREST_LISTEN,
    ASSET_14B_ANIM_unk,
    ASSET_14C_ANIM_BOGGY_IDLE,
    ASSET_14D_ANIM_BOGGY_HIT_BY_SLED,
    ASSET_14E_ANIM_BOGGY_JIGGY_IN_BELLY,
    ASSET_14F_ANIM_BOGGY_RUN,
    ASSET_150_ANIM_BOGGY_SLED,
    ASSET_151_ANIM_RACE_FLAG_HIT,
    ASSET_152_ANIM_RACE_FLAG,
    ASSET_153_ANIM_BURIED_TREASURE_APPEAR,
    ...
    ASSET_160_ANIM_unk,
    ASSET_161_ANIM_unk,
    ASSET_162_ANIM_TOOTS_IDLE,
    ASSET_163_ANIM_unk,
    ASSET_164_ANIM_TOOTS_SING,
    ASSET_165_ANIM_BEEHIVE_IDLE,
    ASSET_166_ANIM_BURIED_TREASURE_BOUNCE,
    ASSET_167_ANIM_BSREST_MOVE,
    ASSET_168_ANIM_unk,
    ASSET_169_ANIM_unk,
    ASSET_16A_ANIM_BELL_BUOY,
    ASSET_16B_ANIM_SNAREBEAR_ATTACK,
    ASSET_16C_ANIM_SNAREBEAR_IDLE,
    ASSET_16D_ANIM_TWINKLYBOX_OPENING,
    ASSET_16E_ANIM_MUMBO_RECLINE,
    ...
    ASSET_178_ANIM_TWINKLY_SPAWNING,
    ASSET_179_ANIM_BOGGY_SLED_HURRY_UP,
    ASSET_17A_ANIM_BOGGY_SLED_LOOK_BACK,
    ASSET_17B_ANIM_BOGGY_unk,
    ASSET_17C_ANIM_TWINKLY_IDLE,
    ASSET_17D_ANIM_POLAR_BEAR_CUB_HAPPY,
    ...
    ASSET_187_ANIM_unk,
    ASSET_188_ANIM_BSPUMPKIN_DIE,
    ASSET_189_ANIM_FLOTSAM_DIE,
    ASSET_18A_ANIM_XMAS_GIFT,
    /*stub*/ ASSET_18B_ANIM_stub,
    /*stub*/ ASSET_18C_ANIM_stub,
    ASSET_18D_ANIM_CATERPILLAR_UNK,
    ASSET_18E_ANIM_CATERPILLAR_IDLE,
    ASSET_18F_ANIM_unk,
    ASSET_190_AMIM_unk,
    ASSET_191_AMIM_unk,
    ASSET_192_AMIM_unk,
    ...
    ASSET_197_AMIM_unk,
    ASSET_198_AMIM_unk,
    ASSET_199_ANIM_EEYRIE_ADULT_UNK,
    ASSET_19A_ANIM_EEYRIE_ADULT_UNK,
    ASSET_19B_ANIM_UNKNOWN,
    ASSET_19C_ANIM_BSWALRUS_BOUNCE,
    ASSET_19D_ANIM_BSWALRUS_DIE,
    ASSET_19E_ANIM_BSWALRUS_SLED,
    ASSET_19F_ANIM_BSWALRUS_SLED_JUMP,
    ASSET_1A0_ANIM_unk,
    ASSET_1A1_ANIM_SLED,
    ASSET_1A2_ANIM_NABNUT_SLEEP,
    ASSET_1A3_ANIM_NABNUT_SPRING_LOOKING_AROUND,
    ASSET_1A4_ANIM_NABNUT_SPRING_EATING,
    /*stub*/ ASSET_1A5_ANIM_stub,
    ASSET_1A6_ANIM_GNAWTY_IDLE,
    ASSET_1A7_ANIM_GNAWTY_CHEERING,
    ASSET_1A8_ANIM_GNAWTY_RUNNING,
    ASSET_1A9_ANIM_BSWALRUS_LOSS,
    ASSET_1AA_ANIM_BOGGY_RACE_WIN,
    ASSET_1AB_ANIM_BOGGY_RACE_LOSE,
    ASSET_1AC_ANIM_WOZZA_HOLDING_JIGGY,
    ASSET_1AD_ANIM_WOZZA_THROWING_JIGGY,
    ASSET_1AE_ANIM_WOZZA_LEAVING,
    ASSET_1AF_ANIM_TWINKLY_MUNCHER_APPEAR,
    ASSET_1B0_ANIM_TWINKLY_MUNCHER_DIE,
    ASSET_1B1_ANIM_TWINKLY_MUNCHER_IDLE,
    ASSET_1B2_ANIM_TWINKLY_MUNCHER_ATTACK,
    ASSET_1B3_ANIM_WOZZA_unk,
    ASSET_1B4_ANIM_WOZZA_unk,
    ASSET_1B5_ANIM_WOZZA_unk,
    ASSET_1B6_ANIM_WOZZA_unk,
    ASSET_1B7_ANIM_unk,
    ASSET_1B8_ANIM_unk,
    ASSET_1B9_ANIM_unk,
    ASSET_1BA_ANIM_unk,
    ...
    ASSET_1D4_ANIM_unk,
    ASSET_1D5_ANIM_unk,
    ASSET_1D6_ANIM_SEAMAN_GRUBLIN_IDLE_WALK,
    ASSET_1D7_ANIM_SEAMAN_GRUBLIN_CHASE,
    ASSET_1D8_ANIM_SEAMAN_GRUBLIN_ALERT,
    ASSET_1D9_ANIM_SEAMAN_GRUBLIN_DIE,
    ASSET_1DA_ANIM_CRAB_IDLE,
    ASSET_1DB_ANIM_MUTANT_CRAB_IDLE,
    ASSET_1DC_ANIM_BEE_FLY,
    ASSET_1DD_ANIM_BEE_WALK,
    ASSET_1DE_ANIM_BEE_IDLE,
    ASSET_1DF_ANIM_unk,
    ASSET_1E0_ANIM_BEE_OW,
    ASSET_1E1_ANIM_BEE_DIE,
    ASSET_1E2_ANIM_BEE_JUMP,
    ASSET_1E3_ANIM_UNKNOWN,
    ASSET_1E4_ANIM_SKELETON_IDLE,
    ASSET_1E5_ANIM_SKELETON_WALK,
    ASSET_1E6_ANIM_SKELETON_ALERT,
    ASSET_1E7_ANIM_SKELETON_BREAK_APART,
    ASSET_1E8_ANIM_SKELETON_REANIMATE,
    ASSET_1E9_ANIM_MUM_MUM_WALK,
    ASSET_1EA_ANIM_MUM_MUM_CURL_UP,
    ASSET_1EB_ANIM_MUM_MUM_POP_FROM_BALL,
    ASSET_1EC_ANIM_unk,
    ASSET_1ED_ANIM_GRAVESTONE_OW,
    ASSET_1EE_ANIM_GRAVESTONE_DIE,
    ASSET_1EF_ANIM_unk,
    ASSET_1F0_ANIM_UNKNOWN,
    ...
    ASSET_215_ANIM_unk,
    ASSET_216_ANIM_unk,
    ASSET_217_ANIM_UNKNOWN,
    ASSET_218_ANIM_unk,
    ASSET_219_ANIM_unk,
    ASSET_21A_ANIM_unk,
    ASSET_21B_ANIM_unk,
    ASSET_21C_ANIM_SNORE_Z,
    ASSET_21D_ANIM_ADULT_EYRIE_UNK,
    ASSET_21E_ANIM_ADULT_EYRIE_UNK,
    /*stub*/ ASSET_21F_ANIM_stub,
    ASSET_220_ANIM_SIR_SLUSH_DIE,
    ASSET_221_ANIM_WOZZA_IN_CAVE,
    ASSET_222_ANIM_BOGGY_ASLEEP,
    ASSET_223_ANIM_TOPPER_UNKNOWN,
    ...
    ASSET_230_ANIM_PINK_SQUIRREL_UNK,
    ASSET_231_ANIM_NABNUT_BEDSHEETS_UNK,
    /*stub*/ ASSET_232_ANIM_stub,
    ASSET_233_ANIM_ICECUBE,
    ASSET_234_ANIM_DEAD_SNAREBEAR,
    ASSET_235_ANIM_unk,
    ASSET_236_ANIM_BSPUMPKIN_REBOUND,
    ASSET_237_ANIM_TWINKLYBOX_SHAKING,
    ASSET_238_ANIM_LOGGO_IDLE,
    ASSET_239_ANIM_LEAKY_IDLE,
    ASSET_23A_ANIM_unk,
    ASSET_23B_ANIM_unk,
    ASSET_23C_ANIM_unk,
    ASSET_23D_ANIM_unk,
    ASSET_23E_ANIM_unk,
    ASSET_23F_ANIM_PORTRAIT_IDLE, // For Portrait Chompas
    ASSET_240_ANIM_LOGGO_FLUSH,
    ASSET_241_ANIM_unk,
    ASSET_242_ANIM_GOBI_RELAXING,
    ASSET_243_ANIM_GRUBLIN_HOOD_IDLE_WALK,
    ASSET_244_ANIM_GRUBLIN_HOOD_ALERT,
    ASSET_245_ANIM_GRUBLIN_HOOD_CHASE,
    ASSET_246_ANIM_GRUBLIN_HOOD_DIE,
    ASSET_247_ANIM_unk,
    ASSET_248_ANIM_unk,
    ASSET_249_ANIM_unk,
    ASSET_24A_ANIM_FSS_BANJO_COOKING_unk,
    ASSET_24B_ANIM_FSS_BANJO_COOKING_unk,
    ASSET_24C_ANIM_FSS_BANJO_COOKING_unk,
    ASSET_24D_ANIM_FSS_BANJO_SLEEPING_unk,
    ASSET_24E_ANIM_FSS_BANJO_SLEEPING_unk,
    ASSET_24F_ANIM_FSS_BANJO_SLEEPING_unk,
    ASSET_250_ANIM_FSS_BANJO_GAMEBOY_unk,
    ASSET_251_ANIM_FSS_BANJO_GAMEBOY_unk,
    ASSET_252_ANIM_FSS_BANJO_GAMEBOY_unk,
    ASSET_253_ANIM_BIGBUTT_OW,
    ASSET_254_ANIM_BIGBUTT_FALL,
    ASSET_255_ANIM_BIGBUTT_GET_UP,
    ASSET_256_ANIM_TERMITE_OW,
    ASSET_257_ANIM_FINALBOSS_unk,
    ASSET_258_ANIM_FINALBOSS_unk,
    ASSET_259_ANIM_FINALBOSS_unk,
    ASSET_25A_ANIM_FINALBOSS_unk,
    ASSET_25B_ANIM_ACORN_IDLE,
    ASSET_25C_ANIM_FINALBOSS_unk,
    ASSET_25D_ANIM_FINALBOSS_unk,
    ASSET_25E_ANIM_FINALBOSS_unk,
    ASSET_25F_ANIM_FINALBOSS_unk,
    ASSET_260_ANIM_FINALBOSS_unk,
    ASSET_261_ANIM_FINALBOSS_unk,
    ASSET_262_ANIM_BOSSJINJO_unk,
    ASSET_263_ANIM_FINALBOSS_unk,
    ASSET_264_ANIM_BOSSJINJO_unk,
    ASSET_265_ANIM_STONEJINJO_unk,
    ASSET_266_ANIM_FINALBOSS_unk,
    ASSET_267_ANIM_FINALBOSS_unk,
    ASSET_268_ANIM_unk,
    ASSET_269_ANIM_unk,
    ASSET_26A_ANIM_unk,
    ASSET_26B_ANIM_unk,
    ASSET_26C_ANIM_unk,
    ASSET_26D_ANIM_GRUNTLING_IDLE,
    ASSET_26E_ANIM_GRUNTLING_UNK,
    ASSET_26F_ANIM_GRUNTLING_UNK,
    ASSET_270_ANIM_GRUNTLING_UNK,
    ASSET_271_ANIM_unk,
    ASSET_272_ANIM_unk,
    ASSET_273_ANIM_SNACKER_HURT,
    ASSET_274_ANIM_SNACKER_DIE,
    ASSET_275_ANIM_JINJONATOR_unk,
    ASSET_276_ANIM_JINJONATOR_unk,
    ASSET_277_ANIM_JINJONATOR_unk,
    ASSET_278_ANIM_JINJONATOR_unk,
    ASSET_279_ANIM_FINALBOSS_unk,
    ASSET_27A_ANIM_FINALBOSS_unk,
    ASSET_27B_ANIM_JINJONATOR_unk,
    ASSET_27C_ANIM_JINJONATOR_unk,
    ASSET_27D_ANIM_JINJONATOR_unk,
    ASSET_27E_ANIM_JINJONATOR_unk,
    ASSET_27F_ANIM_JINJONATOR_unk,
    ASSET_280_ANIM_JINJONATOR_unk,
    ASSET_281_ANIM_WISHYWASHY_DOOOH,
    ASSET_282_ANIM_BSJIG_NOTEDOOR,
    ASSET_283_ANIM_FINALBOSS_unk,
    ASSET_284_ANIM_unk, // "press start" overlay
    ASSET_285_ANIM_unk, // "press start" overlay
    ASSET_286_ANIM_unk, // "no controller" overlay
    ASSET_287_ANIM_unk, // "no controller" overlay
    ...
    ASSET_29F_ANIM_unk,
    ASSET_2A0_ANIM_unk,
    ASSET_2A1_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A2_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A3_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A4_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A5_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A6_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A7_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A8_ANIM_BOTTLES_BONUS_CURSOR_UNKNOWN,
    ASSET_2A9_ANIM_BAT_FALL,
    ...
    ASSET_2BE_ANIM_unk,
    ASSET_2BF_ANIM_unk,
    ASSET_2C0_ANIM_CHUMP_DIE,
    ASSET_2C1_ANIM_unk,
    ASSET_2C2_ANIM_unk,
    ASSET_2C3_ANIM_unk,
    ASSET_2C4_ANIM_unk,
    ASSET_2C5_ANIM_unk,
    ASSET_2C6_ANIM_MUMBOS_HAND_WITH_PICTURE,
    ASSET_2C7_ANIM_MUMBOS_HAND_WITH_PICTURE,
    ASSET_2C8_ANIM_MUMBOS_HAND_WITH_PICTURE,
    /*stub*/ ASSET_2C9_ANIM_stub,
    /*stub*/ ASSET_2CA_stub,
    /*stub*/ ASSET_2CB_stub,
    /*stub*/ ASSET_2CC_stub,
    /*stub*/ ASSET_2CD_stub,
    ...
    /*stub*/ ASSET_2CF_stub,
    /*stub*/ ASSET_2D0_stub,
    ASSET_2D1_MODEL_unk, // Grey House Brick (Upon Smashing MM Huts)
    ASSET_2D2_MODEL_ORANGE, //projectile
    // 2d3 MM Conga Tree
    // 2d4 (Shadow?)
    // 2d5 FP Blue Present
    ...
    ASSET_2DD_MODEL_SHOCK_JUMP_PAD = 0x2DD,
    // Unused
    // 2df TTC Light Crate
    // 2e0 TTC Dark Crate
    ...
    ASSET_340_BEAUTY_MACHINE = 0x340,
    ASSET_341_BEAUTY_MACHINE_CONSOLE,
    // 342 GV Short Platform
    // 343 Tooty Picture Frame
    // 344 (Wooden Block?)
    // 345 (Golden Block?)
    // 346 (Transparent Ice Floor?)
    ASSET_347_MODEL_MACHINE_ROOM_DOOR = 0x347,
    // 348 (Leaf Floor?)
    // 349 (Unknown?)
    // 34a Floor Cobweb
    // 34b Banjo's Bed
    ...
    ASSET_354_MODEL_SMALL_BULL,
    ASSET_355_MODEL_CONCERT_BANJO,
    ASSET_356_MODEL_BANJO_WISHYWASHY = 0x356,
    // 357 Unused
    ASSET_358_SNIPPET = 0x358,
    ASSET_359_MODEL_BANJO_WALRUS,
    ASSET_35A_MODEL_CONCERT_TOOTY,
    ASSET_35B_MODEL_TOOTY = 0x35b,
    ...
    // Unused
    ASSET_369_MODEL_CONCERT_FROG = 0x369,
    // Unused
    ...
    ASSET_38B_MODEL_BOGGY_RACE_FLAG,
    ...
    // Unused
    // Unused
    ASSET_3A6_MODEL_INTRO_N64_CUBE = 0x3A6,
    ASSET_3A7_MODEL_INTRO_RARE_LOGO,
    // 3a8 (Brown Triangle?)
    ...
    // 3b1 Concert Mumbo
    ASSET_3B2_MODEL_TWO_ICE_POLES_NEAR_CHEATO_3 = 0x3B2,
    ASSET_3B3_MODEL_CCW_MUMBOS_HUT,
    ASSET_3B4_MODEL_UNUSED,
    ASSET_3B5_MODEL_UNUSED,
    ASSET_3B6_MODEL_TTC_STAIRS_1,
    ASSET_3B7_MODEL_TTC_STAIRS_2,
    // Unused
    // Unused
    // Unused
    ...
    ASSET_3CC_MODEL_1881_BARREL_TOP,
    ASSET_3CD_MODEL_SHACK_DOOR,
    ASSET_3CE_MODEL_MANSION_DOOR,
    ASSET_3CF_MODEL_CELLAR_HATCH,
    ASSET_3D0_MODEL_CHURCH_GATE_LEFT_LOCK,
    ASSET_3D1_MODEL_HEDGE_GATE_RIGHT_LOCK_1,
    ...
    ASSET_3E1_MODEL_RUBEES_EGG_POT,
    ASSET_3E2_MODEL_GV_KAZOOIE_TARGET,
    ASSET_3E3_MODEL_GOBI_ROPE,
    ASSET_3E4_MODEL_GOBI_ROCK,
    ASSET_3E5_MODEL_GRABBA_SHADOW,
    ASSET_3E6_JINXY_HEAD_KING_SANDYBUTT,
    ASSET_3E7_MODEL_MAGIC_CARPET_SHADOW,
    ...
    ASSET_402_MODEL_EGG_TOLL, // Floating Green Orb
    ASSET_403_MODEL_RUSTY_BUCKET_REAR_PROPELLER,
    ASSET_404_MODEL_RBB_GREEN_PROPELLER_SWITCH,
    ASSET_405_MODEL_RBB_GREY_PROPELLER_SWITCH,
    ASSET_406_MODEL_RBB_SPINNING_SINGLE_PIPE,
    ASSET_407_MODEL_RBB_SPINNING_DOUBLEE_PIPE_RIGHT,
    ASSET_408_MODEL_RBB_SPINNING_DOUBLEE_PIPE_LEFT,
    ASSET_409_MODEL_RBB_SMALL_COG,
    ASSET_40A_MODEL_RBB_MEDIUM_COG,
    ASSET_40B_MODEL_RBB_LARGE_COG,
    ASSET_40C_MODEL_RBB_SPINNING_FLAT_PLATFORM_1,
    ASSET_40D_MODEL_RBB_SPINNING_FLAT_PLATFORM_2,
    ASSET_40E_MODEL_RBB_SPINNING_FLAT_PLATFORM_3,
    ASSET_40F_MODEL_ENGINE_ROOM_PROPELLER_1,
    ASSET_410_MODEL_ENGINE_ROOM_PROPELLER_2,
    ASSET_411_MODEL_ENGINE_ROOM_PROPELLER_3,
    ASSET_412_MODEL_RBB_GREY_PROPELLER_SWITCH,
    ASSET_413_MODEL_WHISTLE_SWITCH_1,
    ASSET_414_MODEL_WHISTLE_SWITCH_2,
    ASSET_415_MODEL_WHISTLE_SWITCH_3,
    ASSET_416_MODEL_WHISTLE,
    // 417 RBB Whistle 2 (Gold)
    // 418 RBB Whistle 3 (Blue)
    ASSET_419_MODEL_GRIMLET = 0x419,
    ASSET_41A_SPRITE_MUMBO_TOKEN,
    ASSET_41B_MODEL_ANCHOR_SWITCH,
    ASSET_41C_MODEL_SNORKEL,
    ASSET_41D_MODEL_ANCHOR,
    ASSET_41E_MODEL_RAREWARE_FLAG,
    ...
    ASSET_426_MODEL_XMAS_TREE_STAR,
    ASSET_427_MODEL_WOODEN_PLANK,
    ASSET_428_MODEL_BOSS_BOOM_BOX,
    ...
    ASSET_42F_MODEL_RBB_HONEYCOMB_SWITCH = 0x42F,
    ASSET_430_MODEL_GRILLE_CHOMPA,
    ASSET_431_MODEL_BETA_VENT,
    ASSET_432_MODEL_CLANKER_WHIPCRACK = 0x432,
    // Unused
    ASSET_434_MODEL_TOOTS = 0x434,
    ASSET_435_MODEL_CC_GREEN_GRATE,
    ASSET_436_MODEL_CC_TEAL_GRATE,
    // 437 (Unknown?)
    ASSET_438_MODEL_HONEYCOMB_SWITCH = 0x438,
    // 439 (Unknown?)
    ASSET_43A_MODEL_CLANKER_SAWBLADE_PROPELLOR = 0x43A,
    ASSET_43B_MODEL_BELL_BUOY,
    ASSET_43C_MODEL_ROWBOAT,
    ASSET_43D_MODEL_MMM_CLOCK_SWITCH = 0x43D,
    ASSET_43E_MODEL_HEDGE_GATE_RIGHT_LOCK_2,
    // 43f (White Star?)
    ASSET_440_MODEL_SNAREBEAR = 0x440,
    // 441 (Sir Slush Snowball?)
    ASSET_442_MODEL_TWINKLY_BOX = 0x442,
    ASSET_443_MODEL_ZUBBA_HONEY_LUMP,
    ASSET_444_MODEL_CCW_ZUBBA_DOOR,
    ASSET_445_MODEL_CCW_ZUBBA_DOOR,
    ASSET_446_MODEL_ZUBBA,
    ASSET_447_MODEL_CCW_BEANSTALK,
    ...
    ASSET_44F_MODEL_GREEN_FLOOR_MIST,
    ASSET_450_MODEL_DINGPOT,
    ASSET_451_MODEL_GRUNTILDA,
    ASSET_452_MODEL_GRUNTILDA_ARMS,
    ASSET_453_MODEL_DINGPOT_TOP,
    ASSET_454_MODEL_TOOTY_REFLECTION,
    // 455 MMM Limbo
    ASSET_456_MODEL_GRUNTILDAS_BROOMSTICK = 0x456,
    ASSET_457_MODEL_GRUNTILDA_RIDING_BROOMSTICK,
    ASSET_458_MODEL_BANJO_TOP_SLEEPING,
    ASSET_459_MODEL_BANJOS_BED,
    ASSET_45A_SPRITE_GREEN_GLOW,
    ASSET_45B_MODEL_KAZOOIE_RACK,
    ASSET_45C_MODEL_BANJOS_CURTAINS = 0x45C,
    // 45d (Unknown)
    ASSET_45E_MODEL_BANJOS_HOUSE_DOOR = 0x45E,
    // 45f (Firey Rock?)
    ASSET_460_MODEL_KAZOOIE_RACK_FEATHERS = 0x460,
    ASSET_461_MODEL_GREEN_FOG_OUTSIDE_TOWER,
    ASSET_462_MODEL_PINK_SQUIRREL,
    ASSET_463_MODEL_NABNUT_BEDSHEETS,
    ASSET_464_MODEL_NABNUT_BED,
    // 465 Dead Snarebear
    // 466 (Sparkle 2D?)
    ASSET_467_MODEL_TRANSITION_FALLING_JIGGIES = 0x467,
    // 467 (Blank Picture Frame?)
    ASSET_468_MODEL_SEXY_GRUNTILDA = 0x468,
    ASSET_469_MODEL_UGLY_TOOTY,
    ASSET_46A_MODEL_KLUNGO,
    ASSET_46B_MODEL_BEAUTY_MACHINE_FORCE_FIELD,
    ASSET_46C_MODEL_JIGSAW_PUZZLE,
    ASSET_46D_MODEL_LIGHTNING,
    ASSET_46E_MODEL_FISHBOWL,
    ASSET_46F_MODEL_CUCKOO_CLOCK,
    // 470 Banjo's Bookshelves
    // 471 Empty Blow Picture Frame
    ASSET_472_UNKNOWN = 0x472, // Blank Picture?
    ASSET_473_MODEL_BBQ_MUMBO,
    ASSET_474_MODEL_BBQ_GRILL_AND_FISH,
    ASSET_475_SPRITE_GAME_OVER_HEART,
    ASSET_476_SPRITE_BLUE_GLOW,
    ASSET_477_SPRITE_YELLOW_GLOW,
    // 478 (Yellow Glow?)
    ASSET_479_MODEL_BIKINI_GIRL = 0x479,
    // 47a (Brown Ball?)
    ...
    ASSET_48D_MODEL_NABNUT_EATING_ACORNS,
    ASSET_48E_MODEL_ACORN,
    ASSET_48F_MODEL_GNAWTY,
    ASSET_490_MODEL_GNAWTY_BOULDER,
    ASSET_491_MODEL_NOTE_DOOR,
    ASSET_492_MODEL_CABIN_CLOSET_DOOR,
    ASSET_493_MODEL_ENGINE_ROOM_DOOR,
    ASSET_494_MODEL_WOZZA,
    ...
    ASSET_49A_MODEL_TWINKLY_SHARD_ORANGE,
    ...
    ASSET_4A2_MODEL_GL_MM_DOOR_ENTRANCE,
    ASSET_4A3_MODEL_GL_TTC_ENTRANCE_CHEST_LID,
    ASSET_4A4_MODEL_GL_CC_ENTRANCE_LONG_PIPE_GREEN,
    ASSET_4A5_MODEL_GL_CC_ENTRANCE_LONG_PIPE_BLUE,
    ASSET_4A6_MODEL_GL_CC_ENTRANCE_SHORT_PIPE,
    ASSET_4A7_MODEL_GL_CC_IRON_BARS_ENTRANCE,
    ASSET_4A8_MODEL_GL_BGS_PUZZLE_GRATE,
    ASSET_4A9_MODEL_RAISE_PIPE_TO_CC_ENTRANCE_SWITCH,
    ASSET_4AA_MODEL_RAISE_PIPE_TO_BRENTILDA_SWITCH,
    ASSET_4AB_MODEL_RAISE_GRATE_TO_BGS_PUZZLE_SWITCH,
    ASSET_4AC_MODEL_IRON_BARS_UNDER_GRUNTY_STATUE,
    ASSET_4AD_MODEL_GRUNTY_STATUE_BREAKABLE_HAT_TOP,
    ASSET_4AE_MODEL_GL_BGS_DOOR_ENTRANCE,
    ASSET_4AF_MODEL_ICE_BALL_TO_CHEATO,
    ASSET_4B0_MODEL_LEVEL_3_WATER_SWITCH,
    ASSET_4B1_MODEL_GRATE_TO_LEVEL_3_WATER_SWITCH,
    ASSET_4B2_MODEL_LEVEL_2_WATER_SWITCH,
    ASSET_4B3_MODEL_RAREWARE_BOX,
    ASSET_4B4_MODEL_GL_RBB_DOOR_ENTRANCE,
    ASSET_4B5_MODEL_LEVEL_1_WATER_SWITCH,
    ASSET_4B6_MODEL_GRATE_BETWEEN_MMM_AND_RBB_PUZZLES,
    ASSET_4B7_MODEL_GRATE_TO_RBB_PUZZLE,
    ASSET_4B8_MODEL_CCW_PUZZLE_SWITCH,
    // 4b9 (Jiggy Switch Beta?)
    ASSET_4BA_MODEL_SHIP_SHADOW_WINDOW = 0x4BA,
    ASSET_4BB_MODEL_SHIP_SUNNY_WINDOW,
    ASSET_4BC_MODEL_GL_GV_DOOR_ENTRANCE,
    ASSET_4BD_MODEL_GLASS_EYE,
    ASSET_4BE_MODEL_GL_MMM_DOOR_ENTRANCE,
    ASSET_4BF_MODEL_FLOOR_COBWEB,
    ASSET_4C0_MODEL_WINDOW,
    ASSET_4C1_MODEL_WIDE_WINDOW,
    ASSET_4C2_MODEL_TALL_WINDOW,
    // 4c3 FP House
    ...
    ASSET_4D2_MODEL_XMAS_TREE_ICE = 0x4D2,

    ASSET_4D3_MODEL_XMAS_ICE_FRAGMENT = 0x4D3,
    ASSET_4D4_MODEL_TWINKLY_BOX_PAPER_SHARD,
    ASSET_4D5_MODEL_WALL_COBWEB,
    ASSET_4D6_MODEL_GL_CCW_DOOR_ENTRANCE,
    ASSET_4D7_MODEL_GL_FP_DOOR_ENTRANCE_LEFT,
    ASSET_4D8_MODEL_GL_FP_DOOR_ENTRANCE_LEFT,
    ASSET_4D9_MODEL_GL_ADVENT_CALENDAR_HATCH_DOOR,
    ASSET_4DA_MODEL_DINING_DOOR,
    ASSET_4DB_MODEL_SUNNY_LIFEBOAT,
    ASSET_4DC_MODEL_WITCH_SWITCH,
    ASSET_4DD_MODEL_MUMBO_SWITCH,
    ASSET_4DE_MODEL_SHADOW_LIFEBOAT,
    ASSET_4DF_MODEL_WARP_CAULDRON,
    // 4e0 CCW Season Door
    ASSET_4E1_MODEL_GL_WOODEN_COFFIN_NO_LID = 0x4E1,
    ASSET_4E2_MODEL_CRACKED_SKYLIGHT,
    ASSET_4E3_MODEL_DEAD_BEANSTALK,
    ASSET_4E4_MODEL_SNORE_Z,
    ...
    ASSET_4F5_MODEL_CCW_SPRING_SWITCH,
    ASSET_4F6_MODEL_CCW_SUMMER_SWITCH,
    ASSET_4F7_MODEL_CCW_AUTUMN_SWITCH,
    ASSET_4F8_MODEL_CCW_WINTER_SWITCH,
    ASSET_4F9_MODEL_CCW_UNKNOWN_NABNUT_WINDOW,
    ASSET_4FA_MODEL_CCW_AUTUMN_NABNUT_WINDOW,
    ASSET_4FB_MODEL_CCW_WINTER_NABNUT_WINDOW,
    ASSET_4FC_MODEL_CCW_UNKNOWN_NABNUT_WINDOW,
    ASSET_4FD_MODEL_WHIPCRACK,
    ASSET_4FE_MODEL_WHIPCRACK_PART_1,
    ASSET_4FF_MODEL_WHIPCRACK_PART_2,
    ASSET_500_MODEL_WHIPCRACK_PART_3,
    ASSET_501_MODEL_MOUND_OF_ACORNS,
    ASSET_502_MODEL_NABNUT,
    ASSET_503_MODEL_NABNUT_BELLY_FULL,
    ASSET_504_MODEL_ICECUBE,
    ASSET_505_MODEL_ICECUBE_CHUNK,
    ASSET_506_CCW_DEAD_SNAREBEAR,
    ASSET_507_MODEL_GL_GRUNTY_FLOOR_PICTURE_EYE_1,
    ASSET_508_MODEL_GL_GRUNTY_FLOOR_PICTURE_EYE_2,
    ASSET_509_MODEL_GL_SARCOPHAGUS,
    ASSET_50A_MODEL_SHARKFOOD_ISLAND,
    ASSET_50B_MODEL_X_BARREL_TOP,
    ASSET_50C_MODEL_ICE_KEY,
    ASSET_50D_MODEL_SNS_EGG,

    ASSET_511_MODEL_CRYPT_COFFIN_LID = 0x511,
    ...
    // 516 (Wooden Plank?)
    ASSET_517_MODEL_IRON_GATE_NO_LOCK = 0x517,
    ASSET_518_MODEL_CCW_WHIPCRACK_ROOM_DOOR,
    ...
    ASSET_52E_MODEL_CCW_SEASON_DOOR,
    ASSET_52F_MODEL_BANJOS_CHAIR,
    ASSET_530_MODEL_BANJOS_BED,
    ASSET_531_MODEL_GNAWTYS_DEN,
    ASSET_532_MODEL_BANJO_KAZOOIE_CUTSCENES, // (Gameboy/Beer/Sunglasses/Chair)
    ASSET_533_MODEL_NABNUT_DOOR,
    ASSET_534_MODEL_FLIGHT_PAD_SWITCH,
    // 535 Flight Pad Blue Fragment
    // 536 Flight Pad Red Fragment
    // 537 Flight Pad Yellow Fragment
    // 538 Jiggy Podium (Beta?)
    ASSET_539_MODEL_BRENTILDA = 0x539,
    ASSET_53A_MODEL_SHRAPNAL_PIECE_EYE,
    ASSET_53B_MODEL_SHRAPNAL_PIECE_SPIKE,
    ASSET_53C_MODEL_SHRAPNAL_PIECE_PLATE,
    ASSET_53D_MODEL_GRUNTILDA_FINAL_BOSS,
    ASSET_53E_MODEL_GNAWTY_BED,
    ASSET_53F_MODEL_GNAWTY_SHELVES,
    ASSET_540_MODEL_SHOCK_JUMP_PAD_SWITCH,
    ASSET_541_SPRITE_FIREBALL_SPELL_ATTACK,
    // 542 (Shadow?)
    ...
    ASSET_547_MODEL_BLUE_EGG_REFILL_PILLOW,
    ASSET_548_MODEL_RED_FEATHER_REFILL_PILLOW,
    ASSET_549_MODEL_GOLD_FEATHER_REFILL_PILLOW,
    ASSET_54A_MODEL_GRUNTLING_RED = 0x54A,
    // 54b (Big Fireball?)
    ASSET_54C_MODEL_GAME_OVER = 0x54C,
    ASSET_54D_MODEL_BANJO_KAZOOIE_SIGN,
    ASSET_54E_MODEL_COPYRIGHT_OVERLAY,
    ASSET_54F_MODEL_CHEATO,
    ASSET_550_MODEL_LARGE_DOOR_TO_FINAL_BATTLE,
    ASSET_551_MODEL_JINJONATOR,
    ...
    ASSET_55A_MODEL_WORLD_EXIT_PAD,
    ASSET_55B_MODEL_BOGGY_IGLOO,
    ASSET_55C_MODEL_PRESS_START_OVERLAY,
    ...
    ASSET_561_MODEL_GRUNTLING_BLUE,
    ASSET_562_MODEL_GRUNTLING_BLACK,
    ASSET_563_MODEL_LEVEL_ENTRY_SIGNS,
    ASSET_564_MODEL_PURPLE_TEEHEE,
    ASSET_565_MODEL_BOTTLES_BONUS_BANJO_HAND,
    ASSET_566_MODEL_BLACK_SNIPPET,
    ASSET_567_MODEL_BLACK_CRAB_HEAD,
    ASSET_568_MODEL_BLACK_CRAB_LEG,
    ASSET_569_MODEL_BLACK_CRAB_CLAW,
    ASSET_56A_MODEL_FP_HOUSE_CHIMNEY,
    ASSET_56B_MODEL_SANDYBUTT_PYRAMID,
    ASSET_56C_MODEL_THE_END_SIGN,
    ASSET_56D_MUMBOS_HAND_WITH_PICTURE, // Mumbo's Hand with SNS pictures
    ASSET_56E_HAMMERHEAD_BEACH_SCENERY, // Credits map
    // 56F Unused
    // 570 Unused
    // Unused
    // 572 Palm Tree (2D)
    ...
    ASSET_6D1_SPRITE_GOLDFEATHER = 0x6d1,

    ASSET_6D6_SPRITE_MUSIC_NOTE = 0x6d6,
    ASSET_6D7_SPRITE_BLUE_EGGS,
    ...
    SPRITE_BOLD_FONT_GREEN_PURPLE_SPHERE_TEXTURE = 0x6df,
    SPRITE_BOLD_FONT_GREEN_SPHERE_TEXTURE,

    SPRITE_BOLD_FONT_YELLOW_GREEN_SPHERE_TEXTURE = 0x6e4,
    SPRITE_BOLD_FONT_REFLECTIVE_SPHERE_TEXTURE,
    ...
    SPRITE_BOLD_FONT_ORANGE_GRADIENT_TEXTURE,
    SPRITE_BOLD_FONT_ORANGE_SPHERE_TEXTURE,
    SPRITE_BOLD_FONT_BLUE_SPHERE_TEXTURE,
    ...
    ASSET_DA9_DIALOG_MUMBO_CCW_VACATION,
    ASSET_DAA_DIALOG_MUMBO_HAS_ENOUGH_TOKENS,
    ...
    ASSET_DF3_DIALOG_BOTTLES_INTRODUCTION = VER_SELECT(0xdf3, 0xa35, 0, 0),
    ...
    ASSET_E00_DIALOG_BOTTLES_ATTACK_REFRESHER,
    ...
    ASSET_F68_DIALOG_MM_THREE_NEW_MOVES_TO_LEARN,

    ASSET_F6E_DIALOG_DIDNT_LEARN_ALL_MOVES_FROM_MM = 0xF6E,

    ASSET_F79_DIALOG_UNKNOWN = 0xF79,
    ASSET_F7A_DIALOG_UNKNOWN,
    ASSET_F7B_DIALOG_BOTTLES_JIGSAW_PICTURE_MEET,

    ASSET_F7F_DIALOG_BOTTLES_MM_ENTRANCE_BEFORE_OPENING_BEFORE_PODIUM = 0xF7F,
    ASSET_F80_DIALOG_BOTTLES_MM_ENTRANCE_BEFORE_OPENING_AFTER_PODIUM,
    ...
    // ASSET_101E_UNUSED
    ASSET_101F_DIALOG_FF_BK_TILE_DIALOG = 0x101F,
    ASSET_1020_DIALOG_FF_PICTURE_TILE_DIALOG,
    ASSET_1021_DIALOG_FF_MUSIC_TILE_DIALOG,
    ASSET_1022_DIALOG_FF_MINIGAME_TILE_DIALOG,
    ASSET_1023_DIALOG_FF_GRUNTY_TILE_DIALOG,
    ASSET_1024_DIALOG_FF_DEATH_TILE_DIALOG,
    ASSET_1025_DIALOG_FF_JOKER_TILE_DIALOG,
    ...
    ASSET_1040_DIALOG_FURNACE_FUN_PICK_PRICE = 0x1040,
...
enum marker_e{
    MARKER_3_BIGBUTT = 0x3,
    MARKER_4_TERMITE,
    MARKER_5_GRUBLIN,
    MARKER_6_MUMBO,
    MARKER_7_CONGA,

    MARKER_9_SMALL_BULL = 0x9,
    MARKER_A_CHIMPY,
    ...
    MARKER_14_SNACKER,
    MARKER_15_CLAM,
    MARKER_16_UNKNOWN, // src/core2/code_4BE10.c
    MARKER_17_CONCERT_BANJO,

    MARKER_1B_CONCERT_TOOTY = 0x1B,
    MARKER_1C_INTRO_N64_CUBE,
    MARKER_1D_INTRO_RARE_LOGO,

    MARKER_24_CONCERT_BULL = 0x24,
    MARKER_25_CONCERT_FROG,
    MARKER_26_CONCERT_BIGBUTT,

    MARKER_28_CLANKER_SAWBLADE = 0x28,
    MARKER_29_GRILLE_CHOMPA,
    MARKER_2A_WHISTLE_1_YELLOW,
    MARKER_2B_WHISTLE_2_YELLOW,
    MARKER_2C_WHISTLE_3_YELLOW,
    MARKER_2D_WHISTLE_CTRL,
    MARKER_2E_GRIMLET,
    MARKER_2F_ANCHOR_SWITCH,
    MARKER_30_SNORKEL,
    MARKER_31_ANCHOR,
    MARKER_32_PLAYER_SHADOW,
    MARKER_33_LEAKY,
    MARKER_34_CEMETARY_POT,
    MARKER_35_CLIMB_BASE,
    MARKER_36_ORANGE_COLLECTIBLE,
    ...
    MARKER_4E_CLANKER_TOKEN_TOOTH,
    MARKER_4F_CLANKER_JIGGY_TOOTH,
    MARKER_50_BEEHIVE,
    MARKER_51_MM_HUT,
    MARKER_52_JIGGY,
    ...
    MARKER_56_UNKNOWN,
    MARKER_57_STEAM,
    MARKER_58_WADING_BOOTS_TOUCH_SPARKLE,
    MARKER_59_TURBO_TRAINERS_TOUCH_SPARKLE,
    MARKER_5A_JINJO_BLUE,
    ...
    MARKER_76_CONCERT_ANT = 0x76,
    MARKER_77_BBQ_MUMBO,
    MARKER_78_BBQ_GRILL_AND_FISH,
    MARKER_79_TOOTY_REFLECTION,
    MARKER_7A_DINGPOT_TOP,
    MARKER_7B_GRUNTILDA_ARMS,

    MARKER_7F_GREEN_FLOOR_MIST = 0x7F,

    MARKER_8C_BANJOS_CURTAINS = 0x8C,
    MARKER_8D_BANJOS_HOUSE_DOOR,
    ...
    MARKER_9A_1881_BARREL_TOP,
    MARKER_9B_MODEL_PLAYER_SHADOW,
    MARKER_9C_SHACK_DOOR,
    MARKER_9D_MANSION_DOOR,
    MARKER_9E_CELLAR_HATCH,
    MARKER_9F_CHURCH_GATE_LEFT_LOCK,
    MARKER_A0_HEDGE_GATE_RIGHT_LOCK_1,
    MARKER_A1_BLUBBER_SHIP_TOP_HATCH,
    MARKER_A2_CHURCH_DOOR,
    MARKER_A3_BLUBBER,
    ...
    MARKER_B8_MOLEHILL,
    MARKER_B9_FP_SNOWMAN_BUTTON,
    MARKER_BA_XMAS_TREE,
    MARKER_BB_JINXY_HEAD_SANDYBUTT,
    MARKER_BC_GOBI_1,
    MARKER_BD_GOBI_ROPE,
    MARKER_BE_GOBI_ROCK,
    MARKER_BF_GOBI_2,
    ...
    MARKER_D3_X_BARREL_TOP = 0xD3,
    MARKER_D4_SPRING_PAD,
    ...
    MARKER_E4_CS_BK_SLEEPING,
    MARKER_E5_CS_BK_GAMEBOY,
    MARKER_E6_CS_BK_COOKING,
    MARKER_E7_DINING_DOOR,
    ...
    MARKER_FF_HEDGE_GATE_RIGHT_LOCK_2,
    MARKER_100_SPENT_RED_FEATHER,
    MARKER_101_SPENT_GOLD_FEATHER,
    MARKER_102_NOTE_DOOR,
    MARKER_103_MM_WITCH_SWITCH,
    MARKER_104_MMM_WITCH_SWITCH,
    MARKER_105_TTC_WITCH_SWITCH,
    MARKER_106_RBB_WITCH_SWITCH,
    MARKER_107_ENGINE_ROOM_DOOR,
    MARKER_108_CABIN_CLOSET_DOOR,
    MARKER_109_BREAKABLE_BRICK_WALL,
    MARKER_10A_MM_ENTRANCE_DOOR,
    MARKER_10B_RBB_ENTRANCE_DOOR,
    MARKER_10C_BGS_ENTRANCE_DOOR,
    MARKER_10D_TTC_ENTRANCE_CHEST_LID,
    MARKER_10E_CC_ENTRANCE_DOOR,
    MARKER_10F_GL_BGS_PUZZLE_GRATE,
    MARKER_110_RAISE_GRATE_TO_BGS_PUZZLE_SWITCH,
    MARKER_111_GL_CC_ENTRANCE_LONG_PIPE_GREEN,
    MARKER_112_GL_CC_ENTRANCE_LONG_PIPE_BLUE,
    MARKER_113_RAISE_PIPE_TO_CC_ENTRANCE_SWITCH,
    MARKER_114_GL_CC_ENTRANCE_SHORT_PIPE,
    MARKER_115_RAISE_PIPE_TO_BRENTILDA_SWITCH,
    MARKER_116_IRON_BARS_UNDER_GRUNTY_STATUE,
    MARKER_117_GRUNTY_STATUE_BREAKABLE_HAT_TOP,
    MARKER_118_GRATE_TO_LEVEL_3_WATER_SWITCH,
    MARKER_119_GRATE_BETWEEN_MMM_AND_RBB_PUZZLES,
    MARKER_11A_GRATE_TO_RBB_PUZZLE,
    MARKER_11B_WATER_LEVEL_SWITCH_1,
    MARKER_11C_WATER_LEVEL_SWITCH_2,
    MARKER_11D_WATER_LEVEL_SWITCH_3,
    MARKER_11E_ICE_BALL_TO_CHEATO,
    MARKER_11F_RAREWARE_BOX,
    MARKER_120_GV_ENTRANCE,
    MARKER_121_GLASS_EYE,
    MARKER_122_MMM_ENTRANCE_DOOR,
    MARKER_123_WINDOW,
    MARKER_124_BOGGY_1,
    MARKER_125_BOGGY_RACE_FLAG,
    MARKER_126_BOGGY_RACE_FLAG,
    MARKER_127_BAT,
    ...
    MARKER_12C_CCW_WINTER_SWITCH,
    MARKER_12D_CCW_WINTER_SEASON_DOOR,
    MARKER_12E_CCW_AUTUMN_SWITCH,
    MARKER_12F_CCW_AUTUMN_SEASON_DOOR,
    MARKER_130_CCW_SUMMER_SWITCH,
    MARKER_131_CCW_SUMMER_SEASON_DOOR,
    MARKER_132_CCW_SPRING_SWITCH,
    MARKER_133_CCW_SPRING_SEASON_DOOR,
    MARKER_134_UNKNOWN,
    MARKER_135_QUARRIE,

    MARKER_13D_FISHBOWL = 0x13D,
    MARKER_13E_CUCKOO_CLOCK,

    MARKER_148_GREEN_FOG_OUTSIDE_TOWER = 0x148,
    MARKER_149_BIKINI_GIRL,

    MARKER_15E_PIRANHA_WATER_PARTICLES = 0x15E,
    MARKER_15F_RBB_HONEYCOMB_SWITCH,
    MARKER_160_GL_SARCOPHAGUS,
    MARKER_161_GV_WITCH_SWITCH,
    MARKER_162_BGS_WITCH_SWITCH,
    MARKER_163_CRYPT_COFFIN_LID,
    MARKER_164_GL_GRUNTY_FLOOR_PICTURE_EYE_1,
    MARKER_165_GL_GRUNTY_FLOOR_PICTURE_EYE_2,
    MARKER_166_CC_WITCH_SWITCH,
    MARKER_167_SHARKFOOD_ISLAND,
    MARKER_168_ICE_KEY,
    MARKER_169_SNS_EGG,
    MARKER_16A_FF_TELEPORT_PAD, // src/core2/code_4C020.c
    MARKER_16B_SNIPPET_UPSIDEDOWN = 0x16B,
    MARKER_16C_NIPPER,
    MARKER_16D_CHEATO_1,
    MARKER_16E_CHEATO_2,
    MARKER_16F_CHEATO_3,
    MARKER_170_BLUE_EGG_REFILL_PILLOW,
    MARKER_171_RED_FEATHER_REFILL_PILLOW,
    MARKER_172_GOLD_FEATHER_REFILL_PILLOW,
    MARKER_173_CHUMP_FISH_2,
    MARKER_174_GAME_OVER,
    MARKER_175_BANJO_KAZOOIE_SIGN,
    MARKER_176_COPYRIGHT_OVERLAY,
    MARKER_177_PRESS_START_OVERLAY,
    MARKER_178_NO_CONTROLLER_OVERLAY,
    MARKER_179_JIGSAW_PUZZLE,
    MARKER_17A_BOTTLES_BONUS_BANJO_HAND,
    MARKER_17B_UNKNOWN,
    MARKER_17C_MODEL_THE_END_SIGN,
    MARKER_17D_IRON_GATE_NO_LOCK,

    MARKER_182_RBB_EGG_TOLL = 0x182,
    MARKER_183_RBB_CAGE_UP_SWITCH,
    MARKER_184_RBB_TNT_DOWN_SWITCH,
    MARKER_185_RBB_REAR_PROPELLER,
    MARKER_186_RBB_GREEN_PROPELLER_SWITCH,
    MARKER_187_RBB_SPINNING_SINGLE_PIPE_1,
    MARKER_188_RBB_SPINNING_FLAT_PLATFORM_1,
    MARKER_189_RBB_SPINNING_FLAT_PLATFORM_2,
    MARKER_18A_RBB_SPINNING_FLAT_PLATFORM_3,
    MARKER_18B_RBB_SMALL_COG,
    MARKER_18C_RBB_MEDIUM_COG,
    MARKER_18D_RBB_LARGE_COG,
    MARKER_18E_RBB_SPINNING_SINGLE_PIPE_2,
    MARKER_18F_RBB_SPINNING_DOUBLE_PIPE_1,
    MARKER_190_RBB_SPINNING_DOUBLE_PIPE_2,
    MARKER_191_ENGINE_ROOM_PROPELLOR_1,
    MARKER_192_ENGINE_ROOM_PROPELLOR_2,
    MARKER_193_ENGINE_ROOM_PROPELLOR_3,
    MARKER_194_RBB_GREY_PROPELLER_SWITCH,
    MARKER_195_WHISTLE_SWITCH_1,
    MARKER_196_WHISTLE_SWITCH_2,
    MARKER_197_WHISTLE_SWITCH_3,
    MARKER_198_RAREWARE_FLAG,
    ...
    MARKER_1A5_SANDYBUTT_EGG_TOLL,
    MARKER_1A6_BETA_VENT,
    MARKER_1A7_CLANKER_WHIPCRACK,

    MARKER_1A9_CC_BREAKABLE_GRATES = 0x1A9,
    MARKER_1AA_BELL_BUOY,
    MARKER_1AB_ROWBOAT,
    MARKER_1AC_ZUBBA_DOOR,
    MARKER_1AD_ZUBBA_HONEY_LUMP,
    MARKER_1AE_ZUBBA,
    MARKER_1AF_ZUBBA_DOCILE,
    MARKER_1B0_CCW_BEANSTALK = 0x1B0,
    MARKER_1B1_CCW_GOBI,
    MARKER_1B2_CLUCKER_A,
    MARKER_1B3_EAGLE_EGG,
    MARKER_1B4_EEYRIE_BABY,
    MARKER_1B5_CATERPILLAR,
    MARKER_1B6_EEYRIE_ADULT,
    MARKER_1B7_BOOM_BOX,
    MARKER_1B8_BOOM_BOX_MINIGAME_CTRL,
    MARKER_1B9_NABNUT_SPRING,
    MARKER_1BA_NABNUT_FULL_BELLY,
    MARKER_1BB_NABNUT,
    MARKER_1BC_CARRIED_ACORN,
    MARKER_1BD_GNAWTY_SWIMMING,
    MARKER_1BE_GNAWTY_SUMMER,
    MARKER_1BF_GNAWTY_BOULDER,
    MARKER_1C0_BOSS_BOOMBOX_CTRL,

    MARKER_1C2_DEAD_BEANSTALK = 0x1C2,
    MARKER_1C3_SNORE_Z,
    MARKER_1C4_CUTSCENE_ADULT_EYRIE,
    MARKER_1C5_WHIPCRACK,
    MARKER_1C6_MOUND_OF_ACORNS,
    MARKER_1C7_PINK_SQUIRREL,
    MARKER_1C8_NABNUT_BEDSHEETS,
    MARKER_1C9_NABNUT_BED,
    MARKER_1CA_NABNUT,
    MARKER_1CB_NABNUT_EATING_ACORNS,
    MARKER_1CC_CCW_UNKNOWN,
    MARKER_1CD_GV_MAZE_CTRL,
    MARKER_1CE_INDOOR_GNAWTY,
    MARKER_1CF_GRILLE_CHOMPA_ATTACKING,
    MARKER_1D0_CLUCKER_B,
    MARKER_1D1_PORTRAIT_CHOMPA_B,
    MARKER_1D2_SPINNING_SINGLE_PIPE_SFX_CTRL,
    MARKER_1D3_DOUBLE_SINGLE_PIPE_SFX_CTRL,
    MARKER_1D4_SANDYBUTT_PYRAMID,
    MARKER_1D5_PALM_TREE,

    MARKER_1E0_BRENTILDA = 0x1E0,
    MARKER_1E1_FF_MINIGAME,
    ...
    MARKER_1F0_SM_BRIDGE_CHECKSUM_TRIGGER = 0x1F0,
    MARKER_1F1_GRUNTLING_BLACK,
    MARKER_1F2_WIDE_WINDOW,
    MARKER_1F3_TALL_WINDOW,
    MARKER_1F4_TOOTS,
    MARKER_1F5_UNKNOWN,
    ...
    MARKER_204_TWINKLY_BOX,
    MARKER_205_TWINKLY_MUNCHER,
    MARKER_206_XMAS_TREE_SWITCH,
    MARKER_207_XMAS_TREE_STAR,
    MARKER_208_BLUE_PRESENT,
    ...
    MARKER_21E_CCW_MUMBOS_HUT = 0x21E,

    MARKER_224_BREAKABLE_FLOOR_COBWEB = 0x224,
    MARKER_225_BREAKABLE_WALL_COBWEB,

    MARKER_227_CCW_ENTRANCE_DOOR = 0x227,
    MARKER_228_FP_ENTRANCE_DOOR_LEFT,
    MARKER_229_FP_ENTRANCE_DOOR_RIGHT,
    MARKER_22A_CCW_WITCH_SWITCH,
    MARKER_22B_FP_WITCH_SWITCH,
    MARKER_22C_GL_ADVENT_CALENDAR_HATCH_DOOR,
    MARKER_22D_SHIP_SHADOW_WINDOW,
    MARKER_22E_SHIP_SUNNY_WINDOW,
    MARKER_22F_SUNNY_LIFEBOAT,
    MARKER_230_SHADOW_LIFEBOAT,
    MARKER_231_WARP_CAULDRON,
    MARKER_232_CCW_PUZZLE_SWITCH,
    MARKER_233_MUMBO_SWITCH,
    MARKER_234_GL_WOODEN_COFFIN_NO_LID,
    MARKER_235_CRACKED_SKYLIGHT,
    MARKER_236_CCW_UNKNOWN_NABNUT_WINDOW,
    MARKER_237_CCW_AUTUMN_NABNUT_WINDOW,
    MARKER_238_CCW_WINTER_NABNUT_WINDOW,
    MARKER_239_CCW_UNKNOWN_NABNUT_WINDOW,
    MARKER_23A_GV_SNS_CHAMBER_DOOR,
    MARKER_23B_GV_SNS_SARCOPHAGUS,
    MARKER_23C_GV_SNS_SWITCH,

    MARKER_23F_LAIR_FLIGHT_PAD_SWITCH = 0x23F,
    MARKER_240_LAIR_SWITCH_FLIGHT_PAD,
    MARKER_241_SHOCK_JUMP_PAD_SWITCH,
    MARKER_242_LAIR_SWITCH_SHOCK_JUMP_PAD,
    MARKER_243_NABNUT_DOOR,
    MARKER_244_DINGPOT,
    MARKER_245_XMAS_TREE_EGG_TOLL,

    MARKER_250_ICECUBE_A = 0x250,
    MARKER_251_DEAD_SNAREBEAR,
    MARKER_252_LOGGO,
    ...
    MARKER_25E_GRUNTILDA_FINAL_BOSS_VULNERABLE,
    MARKER_25F_ICECUBE_B,
    MARKER_260_GRUNTY_PHASE_1_2_MOVING,
    MARKER_261_FIGHT_FLIGHT_PAD,

    MARKER_263_CCW_WHIPCRACK_ROOM_DOOR = 0x263,
    MARKER_264_LARGE_DOOR_TO_FINAL_BATTLE,
    MARKER_265_WORLD_EXIT_PAD,
    MARKER_266_LEVEL_ENTRY_SIGNS,
    MARKER_267_LIGHTHOUSE_A,
    MARKER_268_STAIRS_1,
    MARKER_269_STAIRS_2,
    MARKER_26A_LIGHTHOUSE_B,
    MARKER_26B_GNAWTYS_DEN,
    MARKER_26C_GNAWTYS_BED,
    MARKER_26D_GNAWTYS_SHELVES,
    MARKER_26E_UNKNOWN, // src/core2/code_4C020.c
    MARKER_26F_UNKNOWN, // src/core2/code_4C020.c
    MARKER_270_TWO_ICE_POLES_NEAR_CHEATO_3,
    ...
    MARKER_281_GRUNTY_PHASE_2_VULNERABLE,
    MARKER_282_GRUNTY_PHASE_3_FLIGHT,
    MARKER_283_GRUNTY_PHASE_4_5_INVULNERABLE,
    MARKER_284_GRUNTY_SPELL_BARRIER,
    MARKER_285_JINJONATOR,

    MARKER_288_GRUNTY_SHADOW = 0x288,

    MARKER_294_MUMBOS_HAND_WITH_PICTURE = 0x294,
...
enum ch_humanoid_baddie_states {
    CHHUMANOIDBADDIE_STATE_1_IDLE_UNK = 1,
    CHHUMANOIDBADDIE_STATE_2_IDLE_UNK,
    CHHUMANOIDBADDIE_STATE_3_RANDOM_CHASE,
    CHHUMANOIDBADDIE_STATE_4_ALERT,
    CHHUMANOIDBADDIE_STATE_5_DIE,
    CHHUMANOIDBADDIE_STATE_6_TURN_TOWARDS_PLAYER,
    CHHUMANOIDBADDIE_STATE_7_CHASE_PLAYER,
    CHHUMANOIDBADDIE_STATE_8_IDLE_UNK,
    CHHUMANOIDBADDIE_STATE_9_INVULNERABLE,
    CHHUMANOIDBADDIE_STATE_A_EXIT_INVULNERABILITY
};

enum ch_mole_ids
{
    CH_SM_MOLE_ID_1_INTRO = 1,
    CH_SM_MOLE_ID_2_CAMERA_CONTROL,
    CH_SM_MOLE_ID_3_DIVE,
    CH_SM_MOLE_ID_4_ATTACK_TUTORIAL,
    CH_SM_MOLE_ID_5_BEAK_BARGE,
    CH_SM_MOLE_ID_6_JUMP_TUTORIAL,
    CH_SM_MOLE_ID_7_CLIMB,
    CH_SM_MOLE_ID_8_BRIDGE,
    CH_MOLE_ID_9_BEAK_BOMB,
    CH_MOLE_ID_A_EGG_FIRING,
    CH_MOLE_ID_B_BEAK_BUSTER,
    CH_MOLE_ID_C_TALON_TROT,
    CH_MOLE_ID_D_SHOCK_JUMP,
    CH_MOLE_ID_E_FLIGHT,
    CH_MOLE_ID_F_WONDERWING,
    CH_MOLE_ID_10_STILT_STRIDE,
...
enum map_warp_GL_ccw_puzzle
{
    ...
    WARP_GL_CCW_PUZZLE_5_NOTE_DOOR,
...
enum map_warp_GL_fp_lobby
{
    ...
    WARP_GL_FP_LOBBY_3_stubbed,
    WARP_GL_FP_LOBBY_4_stubbed,
    WARP_GL_FP_LOBBY_5_MOUTH_EXIT,
...
enum map_warp_GL_mmm_lobby
{
    ...
    WARP_GL_MMM_LOBBY_2_MMM_ENTRANCE,
...
enum map_warp_GL_water_switch_room
{
    ...
    WARP_GL_WATER_SWITCH_ROOM_2_CCW_LOBBY_MUMBO_TOKEN,
    WARP_GL_WATER_SWITCH_ROOM_3_CCW_LOBBY,
...
enum map_warp_GL_furnace_fun
{
    ...
    WARP_GL_FURNACE_FUN_4_AFTER_BOARD = 0x3, //! name or val incorrect

    WARP_GL_FURNACE_FUN_5_TO_TOWER = 0x5,
...
enum map_warp_TTC
{
    ...
    WARP_TTC_4_WORLD_ENTRANCE,
    WARP_TTC_5_UNKNOWN,
    WARP_TTC_6_SHIP_TOP_HATCH,
    ...
    WARP_TTC_80_SHARKFOOD_ISLAND = 0x80
};
...
{
    WARP_CC_INSIDE_CLANKER_1_TOP = 0x1, // is also the fallback entry
...
{
    WARP_GV_RUBEE_PYRAMID_7_ENTRANCE = 0x7
};
...
{
    WARP_MMM_CHURCH_WINDOW_1_ENTRANCE = 0x1
};
...
enum map_warp_CCW_spring
{
    ...
    WARP_CCW_SPRING_6_ZUBBA_HIVE_FRONT,
    WARP_CCW_SPRING_7_NABNUT_DOOR,
    WARP_CCW_SPRING_8_WHIPCRACK,
...
enum map_warp_CCW_summer
{
    ...
    WARP_CCW_SUMMER_6_ZUBBA_HIVE_TOP,
    WARP_CCW_SUMMER_7_NABNUT_DOOR,
    WARP_CCW_SUMMER_8_WHIPCRACK,
...
enum map_warp_CCW_autumn
{
    ...
    WARP_CCW_AUTUMN_5_ZUBBA_HIVE_TOP,
    WARP_CCW_AUTUMN_6_ATTIC,
    WARP_CCW_AUTUMN_7_NABNUT_DOOR,
    WARP_CCW_AUTUMN_8_WHIPCRACK,
...
enum map_warp_CCW_winter
{
    ...
    WARP_CCW_WINTER_5_ATTIC,
    WARP_CCW_WINTER_6_NABNUT_WINDOW_UPPER,
    WARP_CCW_WINTER_7_NABNUT_DOOR_stubbed,
    WARP_CCW_WINTER_8_WHIPCRACK,
...
{
    WARP_CCW_NABNUT_WINTER_2_WINDOW = 0x2
};
...
enum map_warp_LL_temple
{
    WARP_LL_TEMPLE_0
};

enum map_warp_LL_swim
{
    WARP_LL_SWIM_0,
    WARP_LL_SWIM_1
};

enum map_warp_LL_tiptups_cave
{
    WARP_LL_TIPTUPS_CAVE_0
};
...
enum qol_id {
    ...
    QOL_ID_NOTE_SAVING,
    QOL_ID_JINJO_SAVING,
    QOL_ID_HEALTH_SYSTEM_REWORK,
    QOL_ID_WARP_CAULDRON_MENU,
    QOL_ID_DPAD_FUNCTIONALITY,
    QOL_ID_CAMERA_IMPROVEMENTS,
    QOL_ID_BUG_AND_OVERSIGHT_FIXES,
    QOL_ID_IGNORE_FRAMERATE_ALTERING_OBJECTS,
    QOL_ID_SKIPPABLE_CUTSCENES,
    QOL_ID_REIMPLEMENT_EXIT_TO_WITCHS_LAIR,
    QOL_ID_TOGGLEABLE_MOVES,
    QOL_ID_ONLY_B_BUTTON_SKIPS_DIALOG,
    QOL_ID_UNLOCK_PLACE_ALL_PUZZLE_PIECES,
    QOL_ID_SAND_CASTLE_PERMANENTLY_DRAINED,
    QOL_ID_CLUCKER_CUTSCENE_VOLATILE_FLAG,
    QOL_ID_CHEAT_CODES_OVERHAUL,
    QOL_ID_ADDITIONAL_CHEATS
};
#endif
